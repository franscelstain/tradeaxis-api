...
class PriceScaleBreakDetectionTest extends TestCase
{
    ...
    public function test_break_explained_by_a_recorded_corporate_action_is_marked_explained(): void
    {
        ...
        DB::table('market_calendar')->insert([
            ['cal_date' => '2026-07-14', 'is_trading_day' => 1, 'created_at' => $now, 'updated_at' => $now],
            ['cal_date' => '2026-07-15', 'is_trading_day' => 1, 'created_at' => $now, 'updated_at' => $now],
            ['cal_date' => '2026-07-16', 'is_trading_day' => 1, 'created_at' => $now, 'updated_at' => $now],
        ]);
