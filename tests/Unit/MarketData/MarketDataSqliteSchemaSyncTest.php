...
class MarketDataSqliteSchemaSyncTest extends TestCase
{
    ...
    public function test_strategy_v2_schema_is_mirrored_and_contains_no_direct_price_repair_surface(): void
    {
        foreach ([
            ...
            'md_market_calendar_revisions' => ['calendar_revision_id', 'market_code', 'market_segment', 'cal_date', 'revision_uid', 'timezone', 'is_trading_day', 'is_half_day', 'session_state', 'session_open_at', 'session_close_at', 'completed_at', 'recorded_at', 'source_observation_id', 'supersedes_revision_id', 'source_ref', 'source_version', 'provenance_tier', 'reconciled_at', 'reconciliation_source_ref'],
            'md_trading_status_revisions' => ['status_revision_id', 'listing_id', 'instrument_id', 'status_event_uid', 'status_type_code', 'status_code', 'bar_expectation_state', 'board_code', 'authority_class', 'source_name', 'source_payload_hash', 'full_session_verified', 'effective_from', 'effective_to', 'recorded_at', 'retracted_at', 'source_observation_id', 'supersedes_revision_id', 'source_ref', 'verification_state', 'observed_at', 'announced_at', 'operator_name', 'governed_reason_code', 'authoritative_source_ref'],
            ...
            'md_price_scale_break_candidates' => ['candidate_id', 'candidate_uid', 'listing_id', 'prior_trade_date', 'current_trade_date', 'prior_publication_id', 'current_publication_id', 'prior_source_observation_id', 'current_source_observation_id', 'prior_close', 'current_open', 'diagnostic_ratio', 'ratio_direction', 'inferred_ratio', 'inferred_ratio_error_pct', 'candidate_classification', 'continuity_verdict', 'market_calendar_adjacent', 'detector_version', 'config_snapshot_id', 'linkage_state', 'possible_corporate_action_revision_id', 'review_state', 'detected_at', 'supersedes_candidate_id', 'created_at'],
            'md_price_scale_break_candidate_reviews' => ['candidate_review_id', 'candidate_id', 'revision_number', 'review_state', 'evidence_source_observation_id', 'corporate_action_revision_id', 'reviewer', 'review_note', 'recorded_at', 'supersedes_review_id', 'created_at'],
            'md_corporate_action_reconciliations' => ['reconciliation_id', 'reconciliation_uid', 'scope_start', 'scope_end', 'authority_name', 'authority_class', 'scope_complete', 'manifest_sha256', 'manifest_event_count', 'platform_event_count', 'missing_platform_count', 'unexpected_platform_count', 'mismatch_count', 'reconciliation_state', 'details_json', 'recorded_at', 'created_at'],
            ...
            'md_publication_projection_reconciliations' => ['reconciliation_id', 'reconciliation_uid', 'trade_date', 'publication_id', 'run_id', 'publication_version', 'pointer_state', 'reconciliation_state', 'bars_projection_count', 'bars_history_count', 'bars_missing_history_count', 'bars_missing_projection_count', 'bars_value_mismatch_count', 'indicators_projection_count', 'indicators_history_count', 'indicators_missing_history_count', 'indicators_missing_projection_count', 'indicators_value_mismatch_count', 'eligibility_projection_count', 'eligibility_history_count', 'eligibility_missing_history_count', 'eligibility_missing_projection_count', 'eligibility_value_mismatch_count', 'orphan_projection_row_count', 'mismatch_count', 'mismatch_sample_json', 'reconciliation_hash', 'checked_at', 'created_at'],
