...
Behavioral ownership remains in `docs/watchlist/system/**`. The correct continuation is a read-only comparative diagnosis over `eval_id=188-193`; failed evidence must not be edited or deleted.
