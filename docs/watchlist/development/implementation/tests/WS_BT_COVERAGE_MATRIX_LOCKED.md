...
- [`WS_CONTRACT_TEST_CHECKLIST.md`](WS_CONTRACT_TEST_CHECKLIST.md)
- [`WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`](../contracts/WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md)
...
Catatan:
- detail authoritative daftar artefak ada di [`WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`](../contracts/WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md),
...
- `WS_CT_016` dengan fixture [`fixtures/bt_coverage_guard_minimal.json`](bt_coverage_guard_minimal.json)

## Next
- [`WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md`](WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md)
