...
> **CURRENT VERIFICATION OVERRIDE — `WS-REBASELINE-20260819-001`**  
> All C/PR/rehearsal/rollout PASS/FAIL/PARTIAL/DONE/READY below remains historical session data only. It does **not** represent current `WS-Bxx` verification. Current status is Stage Register + Traceability Matrix under the active verification epoch.



## CURRENT ORCHESTRATION OVERRIDE — WS-B STAGE EXECUTION / RE-ENTRY

Historical campaign/session sections below retain their original `PARTIAL`, `BLOCKED`, `FAILED_*`, `DONE_*`, remediation-count, or closure wording as immutable historical evidence. They **must not** be interpreted as the lifecycle taxonomy for current `WS-B00..WS-B12` alignment work.

Current `WS-Bxx` work is governed by:
...
Current rules: every attempt closes with evidence; rerun reads prior lineage; repeated failure/time/fatigue never closes a stage; improving diagnostic convergence keeps the stage active; `DONE` requires declared stage objective/exit criteria; terminal unresolved closure requires objective evidence + reviewed decision. Evaluation stages may be `DONE` with a valid `FAIL` verdict when producing that verdict is the stage objective.
...
- `docs/watchlist/authority/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`;
- `docs/watchlist/authority/strategy/**`;
- `docs/watchlist/development/implementation/guides/**` sebagai translation guidance;
- owner upstream market-data untuk producer-facing consumer read contract.


## CURRENT CANONICAL OVERRIDE — OPTIONAL NON-BLOCKING CONFIRM

Current Weekly Swing strategy supersedes older tracker entries that allowed CONFIRM for non-recommended/active PLAN candidates or treated CONFIRM as a required runtime/proof dependency. Those lines remain below **only as historical implementation evidence** and MUST NOT be used as current behavior authority.

Current rule:

- core runtime completes at final qualified Top Picks (`WS-S04`);
- CONFIRM is optional `WS-S05` and only targets final Top Picks;
- missing/stale/incomplete/delayed decision-time data -> `UNAVAILABLE_RETRYABLE`, not `NOT_ACTIONABLE` and not core failure;
- valid data may be retried within the entry window; expiry without valid evaluation -> `EXPIRED_UNCONFIRMED`;
- core proof/production-use review does not depend on CONFIRM availability; CONFIRM proof is capability-specific.

Current owners: `docs/watchlist/authority/strategy/WS_D1_CONFIRM_ACTIONABILITY.md`, `docs/watchlist/authority/strategy/WS_END_TO_END_STRATEGY_LIFECYCLE.md`, and implementation guard `docs/watchlist/development/implementation/CONFIRM_OPTIONAL_NON_BLOCKING_IMPLEMENTATION_GUARD.md`.

## CURRENT CANONICAL OVERRIDE — MARKET DATA CONSUMER INTAKE

Current Weekly Swing documentation supersedes older tracker entries that reconstructed IHSG/regime/indicator/eligibility facts from Market Data physical tables or treated producer `run_id`/pointer/mirror state as Watchlist intake requirements. Those lines remain below only as historical implementation evidence.

Current rule:

- runtime intake authority is the producer-facing Market Data consumer read contract;
- new current PLAN requires `READABLE + FRESH + effective_trade_date=requested_trade_date`;
- `data_usable` is upstream usability only, not Weekly Swing eligibility;
- bootstrap liquidity selection uses `adv20_close_volume_proxy_idr`; legacy `dv20_idr` is only its compatibility alias;
- active required field missing/invalid removes that ticker from recommendation candidacy, with no zero/default/reconstruction;
- direct `market_benchmark_indicators`, `eod_indicators`, `eod_bars`, current status/master, publication pointer, or similar producer-internal reads are not current runtime authority;
- historical exact/as-known replay uses producer-facing replay/read identity;
- D+1 CONFIRM source is optional and is not implied by the EOD Market Data contract.

Current owners: `docs/watchlist/authority/strategy/WS_MARKET_DATA_INPUT_REQUIREMENTS.md`, `docs/watchlist/development/implementation/MARKET_DATA_INTAKE_IMPLEMENTATION_CONTRACT.md`, and `docs/system_audit/SYSTEM_CROSS_DOMAIN_INPUT_BASELINE.md`.
...
Behavioral ownership remains in `docs/watchlist/authority/strategy/**`. Return/path fields remain evaluation-only. The next evidence must come from operator execution of the read-only comparative command and its complete artifact set; no new catalog may be persisted from source inspection alone.
...
Behavioral ownership remains in `docs/watchlist/authority/strategy/**`. The correct continuation is a read-only comparative diagnosis over `eval_id=188-193`; failed evidence must not be edited or deleted.
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0310
docs/watchlist/records/evidence/runs/LX-WS-0309-EVD-01_C16.md
docs/watchlist/records/evidence/artifacts/c16-source-implementation-summary.json
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0586
```
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0230
docs/watchlist/records/evidence/runs/LX-WS-0229-EVD-01_C15.md
docs/watchlist/records/evidence/artifacts/c15-final-evidence-summary.json
docs/watchlist/records/evidence/artifacts/c15-fix4-param-summary.csv
```
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0201
docs/watchlist/records/evidence/runs/LX-WS-0200-EVD-01_C14.md
docs/watchlist/records/evidence/artifacts/c14-is-run-1.json
docs/watchlist/records/evidence/artifacts/c14-is-run-2.json
docs/watchlist/records/evidence/artifacts/c14-forensic-summary.csv
```
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0178
docs/watchlist/records/evidence/runs/C13_OP_CMDS.md
docs/watchlist/records/evidence/artifacts/c13-exit-axis-support-audit.json
```
...
```text
docs/watchlist/records/history/archive/H0265_C12_EXIT_MODEL_REDESIGN_CONTRACT_FINAL_RESULT_HISTORICAL.md
docs/watchlist/records/evidence/runs/LX-WS-0157-EVD-01_C12.md
docs/watchlist/records/evidence/artifacts/c12-exit-model-redesign-contract.json
```
...
```text
docs/watchlist/records/evidence/runs/C11_EXIT_MODEL_CONTRACT_AUDIT_FINAL_RESULT.md
docs/watchlist/records/evidence/runs/C11_OP_CMDS.md
docs/watchlist/records/evidence/artifacts/c11-exit-model-contract-audit.json
```
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0112
docs/watchlist/records/evidence/runs/C10_OP_CMDS.md
docs/watchlist/records/evidence/artifacts/c10-batched-c07-exit-model-summary.csv
```
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0090
docs/watchlist/records/evidence/runs/C09_OP_CMDS.md
docs/watchlist/records/evidence/artifacts/c09-batched-c07-nullable-context-summary.csv
```
...
```text
docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0089
docs/watchlist/records/evidence/runs/C08_OP_CMDS.md
docs/watchlist/records/evidence/artifacts/c08-batched-c07-drilldown-summary.csv
```
...
- final forensic details are recorded in `docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0075`.
...
- `docs/watchlist/authority/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`
- `docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0671`
- `docs/watchlist/development/implementation/guides/WS_IMPLEMENTATION_SCOPE_AND_BOUNDARY.md`
- `docs/watchlist/development/implementation/guides/WS_MODULE_MAPPING.md`
...
- `docs/watchlist/authority/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`
- `docs/watchlist/development/implementation/guides/WS_IMPLEMENTATION_SCOPE_AND_BOUNDARY.md`
- `docs/watchlist/development/implementation/guides/WS_RUNTIME_ARTIFACT_FLOW.md`
- `docs/market_data/book/Publication_Current_Pointer_Integrity_Contract_LOCKED.md`
...
- `docs/watchlist/development/implementation/contracts/WS_DATA_MODEL_MARIADB.md`
- `docs/watchlist/authority/strategy/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/development/implementation/guides/WS_CANONICAL_FIELD_MATRIX.md`
...
- `docs/watchlist/authority/strategy/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/authority/strategy/09_WS_DYNAMIC_SELECTION_DETERMINISTIC.md`
- `docs/watchlist/development/implementation/contracts/WS_PARAMSET_JSON_CONTRACT.md`
- `docs/watchlist/development/implementation/contracts/WS_PARAMETER_REGISTRY_COMPLETE.md`
...
- `docs/watchlist/development/implementation/contracts/WS_PARAMSET_JSON_CONTRACT.md`
- `docs/watchlist/development/implementation/contracts/WS_PARAMETER_REGISTRY_COMPLETE.md`
- `docs/watchlist/development/implementation/contracts/PARAMSET_CONTRACT_GLOBAL.md`
- `docs/watchlist/development/implementation/guides/WS_CANONICAL_PARAMSET_PROCEDURES.md`
...
- `docs/watchlist/development/implementation/contracts/WS_REASON_CODES_AND_HASH.md`
- `docs/watchlist/authority/strategy/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/development/implementation/contracts/WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`
- `docs/watchlist/development/implementation/tests/WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md`
...
- `docs/watchlist/authority/strategy/WS_HISTORICAL_EVALUATION_STRATEGY.md`
- `docs/watchlist/development/implementation/tests/WS_BT_COVERAGE_MATRIX_LOCKED.md`
- `docs/watchlist/authority/strategy/WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md`
- `docs/watchlist/development/implementation/contracts/WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`
...
- `docs/watchlist/authority/strategy/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/authority/strategy/09_WS_DYNAMIC_SELECTION_DETERMINISTIC.md`
- `docs/watchlist/development/implementation/tests/WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_QUALIFICATION_AND_RANKING.md`
...
- `docs/watchlist/README.md`
- `docs/watchlist/authority/strategy/WS_SCOPE_AND_SUCCESS_CRITERIA.md`
- `docs/watchlist/authority/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/development/implementation/contracts/WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`
...
- `docs/watchlist/authority/governance/audit/README.md`
- `docs/watchlist/authority/governance/WATCHLIST_OWNER_MATRIX.md`
...
- `docs/watchlist/development/implementation/contracts/WS_REASON_CODES_AND_HASH.md`
- `docs/watchlist/development/implementation/tests/WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md`
- `docs/watchlist/development/implementation/db/REASON_CODES_SEED.sql`
- `app/Application/Watchlist/Services/WatchlistConfirmOverlayService.php`
- `app/Application/Watchlist/Services/WatchlistBacktestStrategyService.php`
- `app/Application/Watchlist/Services/WatchlistBacktestRuntimeArtifactService.php`
- `app/Application/Watchlist/Services/WatchlistBacktestMetricsService.php`
...
- `docs/watchlist/authority/strategy/WS_PRODUCT_OBJECTIVE_AND_LAYERS.md`
- `docs/watchlist/authority/strategy/WS_RUNTIME_FLOW.md`
- `docs/watchlist/authority/strategy/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/authority/strategy/09_WS_DYNAMIC_SELECTION_DETERMINISTIC.md`
- `docs/watchlist/authority/strategy/WS_D1_CONFIRM_ACTIONABILITY.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/development/implementation/contracts/WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_QUALIFICATION_AND_RANKING.md`
...
- `docs/watchlist/development/implementation/tests/WS_CONTRACT_TEST_CHECKLIST.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/development/implementation/contracts/WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`
- `docs/watchlist/authority/strategy/WS_TOP_PICKS_QUALIFICATION_AND_RANKING.md`
- `docs/watchlist/development/implementation/tests/WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md`
...
C01 reference note: docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0577
...
Reference note:
`docs/watchlist/records/history/LEGACY_SPLIT_SOURCE_CATALOG.md#ls-ws-0570`
