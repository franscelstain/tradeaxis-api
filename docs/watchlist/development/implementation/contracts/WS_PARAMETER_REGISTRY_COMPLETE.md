...
## Prerequisites
### Weekly Swing
- [`WS_PARAMSET_JSON_CONTRACT.md`](WS_PARAMSET_JSON_CONTRACT.md)
...
Aturan perubahan status paramset dan prosedur promote ACTIVE tetap dimiliki oleh `WS_CANONICAL_PARAMSET_PROCEDURES.md`.
...
Parameter boleh origin=BT hanya jika tercakup pada [`WS_BT_COVERAGE_MATRIX_LOCKED.md`](../tests/WS_BT_COVERAGE_MATRIX_LOCKED.md).
...
## Next
### Weekly Swing
- [`WS_PARAMSET_VALIDATOR_SPEC.md`](WS_PARAMSET_VALIDATOR_SPEC.md)
