...
Contoh Weekly Swing dirujuk dari:
- [`../contracts/WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`](WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md)
...
## Next
- [`07_CONTRACT_FAILURE_CODES_LOCKED.md`](CONTRACT_FAILURE_CODES_LOCKED.md)
