...
> **Strategy owner:** `../../../authority/strategy/WS_HISTORICAL_EVALUATION_STRATEGY.md`
> **Acceptance owners:** `../../../authority/strategy/WS_IS_SUFFICIENCY_AND_WINNER_FREEZE.md`, `../../../authority/strategy/WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md`
...
Artifact owner: `../evidence_contracts/WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`.
...
- `../verification/WS_BT_COVERAGE_MATRIX_LOCKED.md`;
- `../verification/WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md`.
...
Exact artifact allowlist remains owned by `../evidence_contracts/WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`.
