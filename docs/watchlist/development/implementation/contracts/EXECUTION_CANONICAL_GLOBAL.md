...
- [`04_CONTRACT_TESTS_GLOBAL.md`](CONTRACT_TESTS_GLOBAL.md)
...
Database watchlist global ada di folder [`../persistence/`](../README.md):
- [`../persistence/01_DB_OVERVIEW.md`](../db/DB_OVERVIEW.md)
...
- [`../persistence/04_DB_SEED_GLOBAL.sql`](../db/DB_SEED_GLOBAL.sql)
...
Contoh Weekly Swing:
- [`../../../authority/strategy/WS_RUNTIME_FLOW.md`](../../../authority/strategy/WS_RUNTIME_FLOW.md) — canonical runtime artifact flow Weekly Swing
