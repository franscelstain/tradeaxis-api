...
## Prerequisites
- [`WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md`](../../../authority/strategy/WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md)
- [`19_WS_DEPRECATED_OR_NONSCOPE_ARTIFACTS_LEDGER.md`](../../../records/history/archive/H0084_19_WS_DEPRECATED_OR_NONSCOPE_ARTIFACTS_LEDGER.md)
...
- [`WS_HISTORICAL_EVALUATION_STRATEGY.md`](../../../authority/strategy/WS_HISTORICAL_EVALUATION_STRATEGY.md)
- [`WS_BT_COVERAGE_MATRIX_LOCKED.md`](../tests/WS_BT_COVERAGE_MATRIX_LOCKED.md)
- [`WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md`](../tests/WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md)
- [`WS_IS_SUFFICIENCY_AND_WINNER_FREEZE.md`](../../../authority/strategy/WS_IS_SUFFICIENCY_AND_WINNER_FREEZE.md)
- [`WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md`](../../../authority/strategy/WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md)
- [`_refs/WS_OOS_EVIDENCE_NOTE.md`](../../../records/evidence/WS_OOS_EVIDENCE_NOTE.md) — catatan referensi bukti, bukan sumber aturan utama
- [`db/PLAN_UNIVERSE_SNAPSHOT_SCHEMA.md`](../db/PLAN_UNIVERSE_SNAPSHOT_SCHEMA.md)

## 4) Explicit Non-members (LOCKED)
Artefak berikut **bukan** anggota manifest ini kecuali kelak ditambahkan secara eksplisit:
- fixtures pada folder [`fixtures/`](../README.md)
- examples pada folder [`examples/`](../README.md)
...
Campaign-specific R2/C01/C171 evidence transport/manifest sections were moved to `../../../records/history/campaign_addenda/WS_BACKTEST_CAMPAIGN_EVIDENCE_MANIFEST_HISTORY.md`.
