...
- [`03_VALIDATOR_SPEC_GLOBAL.md`](VALIDATOR_SPEC_GLOBAL.md)
- [`05_EXECUTION_CANONICAL_GLOBAL.md`](EXECUTION_CANONICAL_GLOBAL.md)

## Global tests yang wajib ada (LOCKED)

### 1) Schema parity / anti-drift
- Kolom tabel watchlist harus sesuai [`../persistence/02_DB_SCHEMA_MARIADB.md`](../db/DB_SCHEMA_MARIADB.md) dan [`../persistence/05_DB_DDL_MARIADB.sql`](../db/DB_DDL_MARIADB.sql).
...
Contoh Weekly Swing:
- [`../tests/WS_CONTRACT_TEST_CHECKLIST.md`](../tests/WS_CONTRACT_TEST_CHECKLIST.md)
- [`../../../authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md`](../../../authority/strategy/WS_TOP_PICKS_RECOMMENDATION.md)
- [`../contracts/WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`](WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md)
...
- [`../tests/WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md`](../tests/WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md)
- referensi pendukung di [legacy refs archive](../../../records/history/archive/H0334_LEGACY_REFS_README.md)
