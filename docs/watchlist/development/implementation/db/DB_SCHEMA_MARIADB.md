...
## Prerequisites
- [`01_DB_OVERVIEW.md`](DB_OVERVIEW.md)
- [`../shared/06_SCHEMA_PARITY_RULES.md`](../contracts/SCHEMA_PARITY_RULES.md)
...
- runtime_json (LONGTEXT) — payload runtime policy-scoped.
  ...
  - Untuk Weekly Swing aktif saat ini, lihat [`../contracts/WS_DATA_MODEL_MARIADB.md`](../contracts/WS_DATA_MODEL_MARIADB.md) dan [`../../../authority/strategy/WS_D1_CONFIRM_ACTIONABILITY.md`](../../../authority/strategy/WS_D1_CONFIRM_ACTIONABILITY.md).
- reason_codes_json (LONGTEXT)
- created_at
...
Lihat juga: [`../contracts/WS_INTRADAY_SNAPSHOT_TABLES.md`](../contracts/WS_INTRADAY_SNAPSHOT_TABLES.md).
...
Contoh aktif:
- Weekly Swing recommendation persistence: [`../db/RECOMMENDATION_RUNTIME_SCHEMA.md`](RECOMMENDATION_RUNTIME_SCHEMA.md)

## DDL
DDL lengkap tabel global watchlist ada di: [`05_DB_DDL_MARIADB.sql`](DB_DDL_MARIADB.sql).
