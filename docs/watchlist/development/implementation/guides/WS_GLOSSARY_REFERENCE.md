...
**Primary owner document(s)**  
`WS_PLAN_SCORING_AND_TRADE_PLAN.md`, `WS_CANDIDATE_CLASSIFICATION.md`
...
**Primary owner document(s)**  
`WS_D1_CONFIRM_ACTIONABILITY.md`, `WS_INTRADAY_SNAPSHOT_TABLES.md`
...
**Primary owner document(s)**  
`WS_INTRADAY_SNAPSHOT_TABLES.md`
...
**Primary owner document(s)**  
`WS_DATA_MODEL_MARIADB.md`, `WS_INTRADAY_SNAPSHOT_TABLES.md`
...
**Primary owner document(s)**  
`WS_REASON_CODES_AND_HASH.md`, `WS_CONTRACT_TEST_CHECKLIST.md`
...
**Primary owner document(s)**  
`WS_D1_CONFIRM_ACTIONABILITY.md`, `WS_CONTRACT_TEST_CHECKLIST.md`
