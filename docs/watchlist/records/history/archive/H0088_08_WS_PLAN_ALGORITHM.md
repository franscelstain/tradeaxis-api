...
PLAN tidak memilih final recommendation set. RECOMMENDATION adalah lapisan terpisah yang membaca output PLAN immutable.
...
Output pada akhir PLAN assembly menjadi input bagi dua lapisan berbeda:
1. **RECOMMENDATION**
2. **CONFIRM**
...
1. PLAN rules hanya mengatur pembentukan PLAN.
...
5. Recommendation selection **MUST** mengikuti aturan RECOMMENDATION dan tidak boleh diturunkan langsung dari PLAN group membership.
