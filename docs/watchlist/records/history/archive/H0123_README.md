...
4. `WS_RUNTIME_FLOW.md` — core PLAN → RECOMMENDATION flow and optional CONFIRM overlay.
...
10. `WS_D1_CONFIRM_ACTIONABILITY.md` — optional non-blocking D+1 current actionability.
...
13. `validation/WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md` — OOS, friction stress, core forward shadow, optional CONFIRM proof, production-use boundary.
