...
`../START_HERE.md` adalah halaman pertama resmi untuk pembaca/programmer baru. Dokumen tersebut hanya mengurutkan authority yang sudah ada; ia tidak boleh membuat business rule baru.

Detailed technical build order berada di `../implementation/WS_IMPLEMENTATION_BUILD_SEQUENCE.md`, juga sebagai orchestration guide non-owner. Strategy stage dependency tetap dimiliki `../strategy/WS_END_TO_END_STRATEGY_LIFECYCLE.md`.
