...
> **Legacy Extract ID:** `LX-WS-0524-IMP-02`
...
> **Source Sections:** L3-L6 Purpose; L7-L32 Canonical Flow; L33-L51 Runtime Keys; L52-L58 Allowed States; L59-L64 Invalid States; L65-L72 Terminology Guard; L73-L82 Minimum Implementation Outputs; L83-L90 Traceability Pointer; L91-L97 Invalid intake shortcuts; L98-L107 Layer Mapping by Runtime Step; L108-L113 DTO / Result Object Expectations; L114-L121 Forbidden Layer Drift; L122-L125 Chronological OOS bounded-read flow; L126-L139 Published-Price Runtime Metadata Freeze Rule; L140-L158 BT-grid paramset compatibility projection; L173-L188 R2 IS-Only Runtime Artifact Flow
> **Extract Body SHA1:** `ADE3F9F85CD0ECE1ECE2BD4A9C0B8AD4F4037C66`
