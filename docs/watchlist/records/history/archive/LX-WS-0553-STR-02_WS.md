...
> **Legacy Extract ID:** `LX-WS-0553-STR-02`
...
> **Source Sections:** L3-L17 Purpose (LOCKED); L18-L23 Prerequisites; L24-L45 Definitions (LOCKED); L46-L74 Guardrails included (LOCKED); L95-L148 Production snapshot contract for equivalence proof (LOCKED); L149-L168 Missing data rules (LOCKED); L169-L188 Equivalence verification (LOCKED); L189-L248 Audit queries (LOCKED); L249-L251 Next
> **Extract Body SHA1:** `156C8713431F61695A8342941117A87DDA52E61E`
