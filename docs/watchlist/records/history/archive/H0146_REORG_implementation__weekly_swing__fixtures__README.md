...
| `recommended_and_confirmed_pair.json` | Top Pick + evaluated CONFIRM coexist | CROSS-LAYER | confirm tidak ubah recommendation |
| `confirm_unavailable_retryable.json` | missing current data tidak memblokir core | CONFIRM | `UNAVAILABLE_RETRYABLE`, retry allowed |
