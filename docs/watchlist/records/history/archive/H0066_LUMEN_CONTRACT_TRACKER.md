...
Current owners: `docs/watchlist/strategy/weekly_swing/WS_D1_CONFIRM_ACTIONABILITY.md`, `docs/watchlist/strategy/weekly_swing/WS_END_TO_END_STRATEGY_LIFECYCLE.md`, and implementation guard `docs/watchlist/implementation/weekly_swing/CONFIRM_OPTIONAL_NON_BLOCKING_IMPLEMENTATION_GUARD.md`.
...
- `docs/watchlist/strategy/weekly_swing/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
...
- `docs/watchlist/strategy/weekly_swing/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/strategy/weekly_swing/WS_TOP_PICKS_RECOMMENDATION.md`
...
- `docs/watchlist/strategy/weekly_swing/WS_HISTORICAL_EVALUATION_STRATEGY.md`
- `docs/watchlist/implementation/weekly_swing/verification/14_WS_BT_COVERAGE_MATRIX_LOCKED.md`
- `docs/watchlist/strategy/weekly_swing/validation/WS_OOS_STRESS_SHADOW_AND_PRODUCTION_PROOF.md`
...
- `docs/watchlist/strategy/weekly_swing/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/strategy/weekly_swing/WS_TOP_PICKS_QUALIFICATION_AND_RANKING.md`
...
- `docs/watchlist/README.md`
- `docs/watchlist/strategy/weekly_swing/WS_SCOPE_AND_SUCCESS_CRITERIA.md`
- `docs/watchlist/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`
- `docs/watchlist/strategy/weekly_swing/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/implementation/weekly_swing/contracts/23_WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`
...
- `docs/watchlist/strategy/weekly_swing/WS_PRODUCT_OBJECTIVE_AND_LAYERS.md`
- `docs/watchlist/strategy/weekly_swing/WS_RUNTIME_FLOW.md`
- `docs/watchlist/strategy/weekly_swing/WS_PLAN_SCORING_AND_TRADE_PLAN.md`
- `docs/watchlist/strategy/weekly_swing/09_WS_DYNAMIC_SELECTION_DETERMINISTIC.md`
- `docs/watchlist/strategy/weekly_swing/WS_D1_CONFIRM_ACTIONABILITY.md`
- `docs/watchlist/strategy/weekly_swing/WS_TOP_PICKS_RECOMMENDATION.md`
- `docs/watchlist/implementation/weekly_swing/contracts/23_WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`
- `docs/watchlist/strategy/weekly_swing/WS_TOP_PICKS_QUALIFICATION_AND_RANKING.md`
