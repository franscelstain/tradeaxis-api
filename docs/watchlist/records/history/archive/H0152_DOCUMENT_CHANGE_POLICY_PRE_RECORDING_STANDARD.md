...
Strategy lama tidak dihapus. Jika diganti karena keputusan material, pindahkan salinan authoritative sebelumnya ke `history/superseded/` dan hubungkan ke decision record yang menggantikannya.
...
- promotion/activation has an explicit decision record.
