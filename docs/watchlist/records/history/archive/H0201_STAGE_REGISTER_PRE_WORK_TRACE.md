...
| Stage | Maps to | Lifecycle state | Stage / evaluation verdict | Latest attempt | Baseline ID | Convergence | Strategy coverage | Residue state / evidence | Integrity gate | Open finding | Active remediation / decision | Dependency / resume trigger | Successor | Resume from | Last update |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
