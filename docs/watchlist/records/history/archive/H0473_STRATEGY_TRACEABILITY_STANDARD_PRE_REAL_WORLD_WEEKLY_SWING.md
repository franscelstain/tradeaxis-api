...
- total canonical strategy clauses inventoried: **1419**;
- required traceability units: **1213**;
- reference-only/navigation units: **206**;
- mandatory/conditional required units: **1081**;
- optional CONFIRM required units: **132**;
- current canonical strategy owner files inventoried: **14**.
- current inventory includes revisions through `D-WS-20260820-01`; 6 prior semantic clauses remain in the matrix as inactive `SUPERSEDED` historical rows and are not included in the active counts above.
