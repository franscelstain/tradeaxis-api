...
Acceptance gate harus menggunakan effective threshold yang sudah di-resolve; placeholder atau sentinel tidak sah sebagai threshold evaluasi.
...
Urutan input yang tidak dijamin deterministic tidak boleh menjadi implicit tie-breaker.
