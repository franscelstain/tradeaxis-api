...
2. **Read stage execution/re-entry governance** — [`../../authority/governance/STAGE_EXECUTION_AND_REWORK_STANDARD.md`](../../authority/governance/STAGE_EXECUTION_AND_REWORK_STANDARD.md).
3. **Read recurring residue/conformance governance** — [`../../authority/governance/IMPLEMENTATION_RESIDUE_AND_CONFORMANCE_STANDARD.md`](../../authority/governance/IMPLEMENTATION_RESIDUE_AND_CONFORMANCE_STANDARD.md).
...
17. **Record material documentation/contract change** di [`../../authority/governance/DOCUMENT_CHANGE_LOG.md`](../../authority/governance/DOCUMENT_CHANGE_LOG.md).
