...
- total canonical strategy clauses inventoried: **1314**;
- required traceability units: **1108**;
- reference-only/navigation units: **206**;
- mandatory/conditional required units: **985**;
- optional CONFIRM required units: **123**;
- current canonical strategy owner files inventoried: **14**.
- current inventory includes revisions through `D-WS-20260819-07`; 6 prior semantic clauses remain in the matrix as inactive `SUPERSEDED` historical rows and are not included in the active counts above.
