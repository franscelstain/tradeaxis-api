# 16 — WS Evaluation Metrics Sufficiency
...
Selection, entry, exit, holding horizon, cost, slippage, dan executable-bar semantics mengikuti `../12_WS_BACKTEST_AND_CALIBRATION_STRATEGY.md`.
