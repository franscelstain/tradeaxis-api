...
Historical evaluation tidak boleh membuat synthetic historical CONFIRM dari informasi yang tidak tersedia pada decision time. Baseline backtest/OOS membuktikan final **EOD Top Picks**; D+1 CONFIRM actionability dibuktikan secara forward pada shadow stage.
...
IS, OOS, adverse-friction, atau shadow gate failure adalah verdict stage berikutnya dan menghentikan progression; kegagalan tersebut tidak boleh dipakai untuk mengubah historical evaluation rules secara post-hoc.
