...
Dokumen ini mengunci **semantik evaluasi dan kalibrasi** Weekly Swing agar hasil backtest dapat dibandingkan secara konsisten dan reproducible.
...
- Backtest universe harus equivalent dengan PLAN universe yang berlaku untuk tanggal yang sama.
...
- Jika harga tidak dapat dibuktikan executable, trade harus fail closed / di-skip; evaluasi tidak boleh menebak atau merekonstruksi synthetic fill.
...
7. candidate hanya dapat dipertimbangkan untuk activation setelah OOS proof lulus.
...
Threshold acceptance dan canonical ranking metrics mengikuti `validation/16_WS_EVAL_METRICS_SUFFICIENCY_LOCKED.md`; OOS acceptance mengikuti `validation/17_WS_WALK_FORWARD_OOS_PROOF_LOCKED.md`.
