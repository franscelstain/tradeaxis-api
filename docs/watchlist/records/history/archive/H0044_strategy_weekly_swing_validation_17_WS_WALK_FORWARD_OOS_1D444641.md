...
- Evidence dapat diringkas menggunakan format referensi pada [`_refs/WS_OOS_EVIDENCE_NOTE.md`](../../../evidence/weekly_swing/locks/WS_OOS_EVIDENCE_NOTE.md), tetapi kewajiban bukti OOS tetap dikunci oleh dokumen ini.
