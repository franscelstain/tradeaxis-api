...
> **Legacy Extract ID:** `LX-WS-0535-STR-02`
...
> **Source Sections:** L3-L10 Purpose; L11-L16 Scope; L17-L22 Inputs; L23-L28 Outputs; L29-L53 1) Contract Tables (LOCKED); L54-L74 2) Canonical Sources (LOCKED); L97-L114 4) Parity Rules (LOCKED); L115-L123 5) Internal-only Fields; L124-L133 6) Repository Columns Contract (LOCKED); L134-L146 7) Breaking Change Workflow (LOCKED); L147-L155 8) Policy-level Extension Rule; L156-L162 9) Acceptance Rule (LOCKED); L163-L164 Next
> **Extract Body SHA1:** `D56758018C46CE5048FC4749CBFDFA8259B8FB62`
