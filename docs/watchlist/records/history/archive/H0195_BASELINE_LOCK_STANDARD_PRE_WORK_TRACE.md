...
Evidence Record ID: E-WS-YYYYMMDD-NN
```

Satu Attempt ID hanya boleh terikat ke satu Baseline ID. Jika baseline harus diganti, tutup attempt lama dan buka attempt baru.
