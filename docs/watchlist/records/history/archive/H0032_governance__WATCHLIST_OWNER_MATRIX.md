...
1. `docs/watchlist/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`  
   = governance root / boundary root tertinggi.

2. `docs/watchlist/history/documentation_architecture/LEGACY_SYSTEM_README.md`  
   = root orientation / navigasi system docs, tunduk pada governance root.

3. `docs/watchlist/strategy/weekly_swing/*.md`  
   = normative policy owner untuk Weekly Swing.

4. `docs/watchlist/implementation/weekly_swing/guidance/*.md`  
   = implementation translation only, tidak boleh membuat atau mengubah rule bisnis normatif.

5. `docs/watchlist/governance/audit/*.md`  
   = audit guardrail only, tidak boleh menjadi source of truth bisnis.

6. `docs/watchlist/strategy/weekly_swing/_refs/*`  
   `docs/watchlist/strategy/weekly_swing/examples/*`  
   `docs/watchlist/strategy/weekly_swing/fixtures/*`  
   `docs/watchlist/strategy/weekly_swing/db/*`  
...
|---|---|---:|---|---|
| `docs/watchlist/governance/WATCHLIST_DOCUMENT_AUTHORITY.md` | Governance root | Yes | None | A |
| `docs/watchlist/history/documentation_architecture/LEGACY_SYSTEM_README.md` | Root orientation | No | `system/policy.md` | A |
| `docs/watchlist/strategy/weekly_swing/*.md` | Normative policy owner | Yes | `system/policy.md` | A |
| `docs/watchlist/implementation/weekly_swing/guidance/*.md` | Implementation translation | No | governance root + normative policy owner docs | B |
| `docs/watchlist/governance/audit/*.md` | Audit guardrail | No | governance root + normative policy owner docs | A/B |
...
- `docs/watchlist/strategy/weekly_swing/README.md`
...
- `docs/watchlist/implementation/weekly_swing/contracts/06_WS_PARAMSET_VALIDATOR_SPEC.md`
...
- `docs/watchlist/implementation/weekly_swing/persistence/11_WS_INTRADAY_SNAPSHOT_TABLES.md`
- `docs/watchlist/implementation/weekly_swing/testing/13_WS_CONTRACT_TEST_CHECKLIST.md`
- `docs/watchlist/implementation/weekly_swing/guidance/21_WS_IMPLEMENTATION_BLUEPRINT.md`
...
- `docs/watchlist/implementation/weekly_swing/guidance/04_WS_API_GUIDANCE.md`
- `docs/watchlist/implementation/weekly_swing/guidance/05_WS_PERSISTENCE_GUIDANCE.md`
- `docs/watchlist/implementation/weekly_swing/guidance/05A_WS_CANONICAL_FIELD_MATRIX.md`
- `docs/watchlist/implementation/weekly_swing/guidance/06_WS_TEST_IMPLEMENTATION_GUIDANCE.md`
- `docs/watchlist/implementation/weekly_swing/guidance/07_WS_DELIVERY_CHECKLIST.md`

### Audit Guardrail Set
- `docs/watchlist/governance/audit/README.md`
- `docs/watchlist/governance/audit/WATCHLIST_AUDIT_FOUNDATION.md`
- `docs/watchlist/strategy/weekly_swing/00_WS_SCOPE_LOCK.md`
- `docs/watchlist/governance/WATCHLIST_OWNER_MATRIX.md`
- `docs/watchlist/governance/audit/WATCHLIST_AUDIT_CHECKLIST_FINAL.md`
- `docs/watchlist/governance/audit/WATCHLIST_AUDIT_SHORT.md`
- `docs/watchlist/governance/audit/WATCHLIST_AUDIT_PROMPT_STANDARD.md`
- `docs/watchlist/governance/WATCHLIST_CHANGE_IMPACT_MATRIX.md`
...
- `docs/watchlist/strategy/weekly_swing/_refs/*`
- `docs/watchlist/strategy/weekly_swing/examples/*`
- `docs/watchlist/strategy/weekly_swing/fixtures/*`
- `docs/watchlist/strategy/weekly_swing/db/*`
...
7. Jika terjadi konflik, ikuti `docs/watchlist/governance/WATCHLIST_DOCUMENT_AUTHORITY.md`, lalu file owner normatif Weekly Swing yang relevan.
...
They track governance, implementation progress, and contract status. They do not become business-rule owners and must defer to `docs/watchlist/governance/WATCHLIST_DOCUMENT_AUTHORITY.md` plus the relevant normative Weekly Swing owner docs.
