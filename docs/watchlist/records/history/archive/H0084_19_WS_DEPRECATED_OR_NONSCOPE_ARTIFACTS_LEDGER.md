...
1. ditambahkan ke manifest resmi ([`18_WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`](../../../implementation/weekly_swing/evidence_contracts/18_WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md)),
2. memiliki schema atau kontrak yang sah,
...
- [`20_WS_CANONICAL_PARAMSET_PROCEDURES.md`](../../../implementation/weekly_swing/procedures/20_WS_CANONICAL_PARAMSET_PROCEDURES.md)
