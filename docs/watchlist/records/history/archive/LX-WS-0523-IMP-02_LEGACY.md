...
> **Legacy Extract ID:** `LX-WS-0523-IMP-02`
> **Legacy Source ID:** `LS-WS-0523`
> **Legacy Work Key:** `LEGACY`
> **Original Path:** `docs/watchlist/system/implementation/weekly_swing/02_WS_MODULE_MAPPING.md`
> **Original SHA1:** `8C4FDE4697876AC190A06E54C0344E53249976CA`
> **Source Sections:** L3-L9 Purpose; L10-L18 Scope Lock; L26-L61 Recommended Module Set; L62-L74 PLAN intake anchor for module translation; L75-L82 Artifact-to-Module Mapping; L83-L134 Per-Module Contract Boundary; L135-L144 Trigger Matrix; L145-L179 Suggested Build Order (Translation Layer); L180-L192 Mapping to Source of Truth; L193-L202 Forbidden Coupling (LOCKED); L203-L214 Persistence Alignment Note (LOCKED); L215-L222 Final Rule; L223-L240 Canonical Layer Mapping; L241-L257 What Each Module May Read / Decide / Return
> **Extract Body SHA1:** `699A6FBF4B706123636FFE11B44F81CD18B5F3D5`
