...
$legacyErrors=array(); $sourceCount=0; $splitCount=0; $removedSplitCount=0; $retainedCount=0;
...
check($checks,'LEGACY_SOURCE_NORMALIZATION',count($legacyErrors)===0,array('source_count'=>$sourceCount,'retained_source_count'=>$retainedCount,'removed_fully_split_sources'=>$removedSplitCount,'split_extract_count'=>$splitCount,'errors'=>array_slice($legacyErrors,0,30)));
