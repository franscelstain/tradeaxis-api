...
RECOMMENDATION harus menggunakan tie-breaker tersendiri yang deterministik apabila `recommendation_score` menghasilkan nilai yang sama.

## Final Rules

1. Deterministic selection pada aturan ini hanya berlaku untuk PLAN group semantics.
...
5. Recommendation membership **MUST** ditentukan oleh aturan RECOMMENDATION, bukan oleh PLAN dynamic selection.
