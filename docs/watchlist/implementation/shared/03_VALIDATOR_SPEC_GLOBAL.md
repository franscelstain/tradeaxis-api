...
Contoh Weekly Swing:
- Paramset validator: [`../weekly_swing/contracts/06_WS_PARAMSET_VALIDATOR_SPEC.md`](../weekly_swing/contracts/06_WS_PARAMSET_VALIDATOR_SPEC.md)
- Confirm overlay spec: [`../../strategy/weekly_swing/10_WS_CONFIRM_OVERLAY.md`](../../strategy/weekly_swing/10_WS_CONFIRM_OVERLAY.md)
