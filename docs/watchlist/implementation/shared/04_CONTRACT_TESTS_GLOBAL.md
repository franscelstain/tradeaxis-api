...
## Prerequisites
- [`01_POLICY_FRAMEWORK_OVERVIEW.md`](../../governance/WEEKLY_SWING_POLICY_FRAMEWORK.md)
...
- Kolom tabel watchlist harus sesuai [`../persistence/02_DB_SCHEMA_MARIADB.md`](../persistence/02_DB_SCHEMA_MARIADB.md) dan [`../persistence/05_DB_DDL_MARIADB.sql`](../persistence/05_DB_DDL_MARIADB.sql).
...
Contoh Weekly Swing:
- [`../weekly_swing/testing/13_WS_CONTRACT_TEST_CHECKLIST.md`](../weekly_swing/testing/13_WS_CONTRACT_TEST_CHECKLIST.md)
- [`../../strategy/weekly_swing/22_WS_RECOMMENDATION_OVERVIEW.md`](../../strategy/weekly_swing/22_WS_RECOMMENDATION_OVERVIEW.md)
- [`../weekly_swing/contracts/23_WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md`](../weekly_swing/contracts/23_WS_RECOMMENDATION_INPUT_OUTPUT_CONTRACT.md)
- [`../../strategy/weekly_swing/24_WS_RECOMMENDATION_ALGORITHM.md`](../../strategy/weekly_swing/24_WS_RECOMMENDATION_ALGORITHM.md)
- [`../weekly_swing/testing/25_WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md`](../weekly_swing/testing/25_WS_RECOMMENDATION_REASON_CODES_AND_TESTS.md)
- referensi pendukung di [`../../research/weekly_swing/README_LEGACY_REFS.md`](../../research/weekly_swing/README_LEGACY_REFS.md)
