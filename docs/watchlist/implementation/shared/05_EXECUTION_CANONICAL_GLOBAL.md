...
Database watchlist global ada di folder [`../persistence/`](../persistence/README.md):
- [`../persistence/01_DB_OVERVIEW.md`](../persistence/01_DB_OVERVIEW.md)
- [`../persistence/02_DB_SCHEMA_MARIADB.md`](../persistence/02_DB_SCHEMA_MARIADB.md)
- [`../persistence/03_DB_INDEXES_AND_CONSTRAINTS.md`](../persistence/03_DB_INDEXES_AND_CONSTRAINTS.md)
- [`../persistence/04_DB_SEED_GLOBAL.sql`](../persistence/04_DB_SEED_GLOBAL.sql)
- [`../persistence/05_DB_DDL_MARIADB.sql`](../persistence/05_DB_DDL_MARIADB.sql)

## Policy-specific detail
Detail implementasi per policy tetap di folder policy masing-masing.
Contoh Weekly Swing:
- [`../../strategy/weekly_swing/02_WS_CANONICAL_RUNTIME_FLOW.md`](../../strategy/weekly_swing/02_WS_CANONICAL_RUNTIME_FLOW.md) — canonical runtime artifact flow Weekly Swing
