...
- [`../shared/06_SCHEMA_PARITY_RULES.md`](../shared/06_SCHEMA_PARITY_RULES.md)
...
- runtime_json (LONGTEXT) — payload runtime policy-scoped.
  ...
  - Untuk Weekly Swing aktif saat ini, lihat [`../weekly_swing/contracts/03_WS_DATA_MODEL_MARIADB.md`](../weekly_swing/contracts/03_WS_DATA_MODEL_MARIADB.md) dan [`../../strategy/weekly_swing/10_WS_CONFIRM_OVERLAY.md`](../../strategy/weekly_swing/10_WS_CONFIRM_OVERLAY.md).
- reason_codes_json (LONGTEXT)
- created_at
...
Lihat juga: [`../weekly_swing/persistence/11_WS_INTRADAY_SNAPSHOT_TABLES.md`](../weekly_swing/persistence/11_WS_INTRADAY_SNAPSHOT_TABLES.md).
...
Contoh aktif:
- Weekly Swing recommendation persistence: [`../weekly_swing/db/RECOMMENDATION_RUNTIME_SCHEMA.md`](../weekly_swing/db/RECOMMENDATION_RUNTIME_SCHEMA.md)
