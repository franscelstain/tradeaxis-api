...
## Prerequisites
- [`17_WS_WALK_FORWARD_OOS_PROOF_LOCKED.md`](../../../strategy/weekly_swing/validation/17_WS_WALK_FORWARD_OOS_PROOF_LOCKED.md)
- [`19_WS_DEPRECATED_OR_NONSCOPE_ARTIFACTS_LEDGER.md`](../../../history/weekly_swing/superseded/19_WS_DEPRECATED_OR_NONSCOPE_ARTIFACTS_LEDGER.md)
...
- [`12_WS_BACKTEST_AND_CALIBRATION_STRATEGY.md`](../../../strategy/weekly_swing/12_WS_BACKTEST_AND_CALIBRATION_STRATEGY.md)
- [`14_WS_BT_COVERAGE_MATRIX_LOCKED.md`](../verification/14_WS_BT_COVERAGE_MATRIX_LOCKED.md)
- [`15_WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md`](../verification/15_WS_UNIVERSE_EQUIVALENCE_CONTRACT_LOCKED.md)
- [`16_WS_EVAL_METRICS_SUFFICIENCY_LOCKED.md`](../../../strategy/weekly_swing/validation/16_WS_EVAL_METRICS_SUFFICIENCY_LOCKED.md)
- [`17_WS_WALK_FORWARD_OOS_PROOF_LOCKED.md`](../../../strategy/weekly_swing/validation/17_WS_WALK_FORWARD_OOS_PROOF_LOCKED.md)
- [`_refs/WS_OOS_EVIDENCE_NOTE.md`](../../../evidence/weekly_swing/locks/WS_OOS_EVIDENCE_NOTE.md) — catatan referensi bukti, bukan sumber aturan utama
- [`db/PLAN_UNIVERSE_SNAPSHOT_SCHEMA.md`](../db/PLAN_UNIVERSE_SNAPSHOT_SCHEMA.md)
...
## Campaign evidence history
Campaign-specific R2/C01/C171 evidence transport/manifest sections were moved to `../../../history/weekly_swing/campaign_addenda/WS_BACKTEST_CAMPAIGN_EVIDENCE_MANIFEST_HISTORY.md`.
