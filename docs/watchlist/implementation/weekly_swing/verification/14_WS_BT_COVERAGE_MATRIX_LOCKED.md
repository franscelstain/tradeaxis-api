...
- [`13_WS_CONTRACT_TEST_CHECKLIST.md`](../testing/13_WS_CONTRACT_TEST_CHECKLIST.md)
- [`18_WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`](../evidence_contracts/18_WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md)
...
Catatan:
- detail authoritative daftar artefak ada di [`18_WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md`](../evidence_contracts/18_WS_BACKTEST_ARTIFACT_MANIFEST_LOCKED.md),
