...
Dokumen ini adalah **bridge note** antara owner docs Weekly Swing dan implementation guidance di `docs/watchlist/implementation/weekly_swing/guidance/`.
...
1. `docs/watchlist/governance/WATCHLIST_DOCUMENT_AUTHORITY.md` menang
...
- `01_WS_IMPLEMENTATION_SCOPE_AND_BOUNDARY.md`
- `02_WS_MODULE_MAPPING.md`
- `03_WS_RUNTIME_ARTIFACT_FLOW.md`
- `04_WS_API_GUIDANCE.md`
- `05_WS_PERSISTENCE_GUIDANCE.md`
- `06_WS_TEST_IMPLEMENTATION_GUIDANCE.md`
- `07_WS_DELIVERY_CHECKLIST.md`
...
Jika ada kebutuhan detail implementasi yang lebih teknis, tambahkan atau revisi di folder `docs/watchlist/implementation/weekly_swing/`, bukan dengan memperluas authority dokumen ini.
