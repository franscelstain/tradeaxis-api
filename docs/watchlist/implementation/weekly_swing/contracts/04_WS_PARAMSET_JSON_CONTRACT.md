...
C171-specific remediation bounds were moved to `../../../research/weekly_swing/campaign_contracts/WS_C171_PARAMSET_OPTIONAL_BOUND_CONTRACT.md`. They are not part of the canonical generic paramset contract.
