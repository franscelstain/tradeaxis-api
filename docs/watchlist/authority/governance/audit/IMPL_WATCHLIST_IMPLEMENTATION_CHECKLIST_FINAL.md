...
## One Document / One Role Gate

- [ ] Setiap dokumen baru/materially changed mempunyai tepat satu authoritative role.
- [ ] Role tercatat pada `authority/governance/DOCUMENT_ROLE_REGISTRY.csv`.
- [ ] Actual evidence/finding/decision/research payload tidak digabung sebagai authority kedua di implementation document.
- [ ] `WatchlistDocumentationIntegrityGate.php` menunjukkan `ONE_DOCUMENT_ONE_AUTHORITATIVE_ROLE=PASS`.
