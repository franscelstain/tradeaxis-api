...
Folder ini berisi baseline audit untuk **implementation guidance watchlist (Layer B)** dan guardrail saat review implementasi nyata mulai tersedia. Audit ini terpisah dari audit canonical strategy.

Tujuan folder ini:
- menjaga implementasi tetap tunduk pada baseline [`../../strategy/README.md`](../../strategy/README.md);
...
Folder ini **bukan** owner rule bisnis watchlist. Source of truth tetap berada di [`../../strategy/README.md`](../../strategy/README.md).


## Reading Guard

Kata `../../../development/implementation` pada folder ini **default-nya bukan** berarti code audit.
...
- baseline ini tidak boleh mengubah freeze baseline bisnis `weekly_swing` pada [`../../strategy/README.md`](../../strategy/README.md).
...
Untuk aturan penilaian saat Layer C belum aktif, lihat [`WATCHLIST_LAYER_C_APPLICABILITY_RULE.md`](IMPL_WATCHLIST_LAYER_C_APPLICABILITY_RULE.md).
