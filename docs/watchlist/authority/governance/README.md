...
2. [`CURRENT_VERIFICATION_REBASELINE_STANDARD.md`](CURRENT_VERIFICATION_REBASELINE_STANDARD.md) — old verdicts historical-only; current implementation/proof restarts NOT_ASSESSED.
3. [`DOCUMENT_RECORDING_STANDARD.md`](DOCUMENT_RECORDING_STANDARD.md) — lifecycle/mutability/no-silent-update.
...
- [`CURRENT_VERIFICATION_EPOCH.json`](CURRENT_VERIFICATION_EPOCH.json) — machine-readable active verification epoch.
- [`CURRENT_VERIFICATION_REGISTRY.csv`](CURRENT_VERIFICATION_REGISTRY.csv) — current verification disposition for every physical Watchlist document.
