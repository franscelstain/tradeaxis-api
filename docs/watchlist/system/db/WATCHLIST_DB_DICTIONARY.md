...
- Watchlist must not infer Market Data table/column names.
- Watchlist must resolve date keys, identifier keys, field role, and as-of safety from the Market Data dictionary before implementation.
