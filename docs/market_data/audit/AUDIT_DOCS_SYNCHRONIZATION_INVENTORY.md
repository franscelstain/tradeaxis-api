...
| Reason code seed | `docs/market_data/registry/Reason_Codes_Seed.sql` | Seed contains 315 reason codes. | Seed must stay in sync with registry and remain idempotent. | Closed. | No seed patch required. | Static scan: 315 seed codes. | SYNCED |
