...
| P1-26 dua migration terakhir tidak pernah diterapkan | `OPEN` | Tabel `migrations` berhenti di `2026_07_30_000005`. Berkas `2026_08_02_000001_add_market_data_strategy_v2_foundation.php` dan `2026_08_03_000001_harden_market_data_orders_1_to_4.php` ada tetapi tidak tercatat sebagai diterapkan. Yang pertama membuat tiga belas tabel `md_*` yang menjadi fondasi strategi V2. **Ini akar bersama dari `P1-16`, `P1-20`, `P1-21`, `P1-25`, dan sebagian `P1-17`** — kelimanya bukan cacat independen melainkan satu batch yang belum dijalankan. Test tetap hijau karena mirror SQLite ditulis tangan mengikuti schema yang dimaksud, bukan schema yang terdeploy. Ditemukan saat verifikasi order 20 |
