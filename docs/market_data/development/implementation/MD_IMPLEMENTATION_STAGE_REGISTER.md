...
| `MD-B19` | `W19` — Bangun daily/backfill/correction/replay operations, locking, observability, evidence export, dan recovery | `NOT_STARTED` | — | — | — | `0/125 mandatory + 0/1 optional` | `NOT_ASSESSED` | `NOT_RUN` | `MD-DEP-0003` | `F-MD-B00-A001-001` (Class S half) | — | begin/revalidate stage; 7 test files still bound to split-sealed composites |
