...
/**
 * `MD-B17` stage-closure condition gate.
 *
 ...
 */
final class MarketDataReadProductClosureGate
{
    public const EVIDENCE = 'E-MD-B17-A002-001';

    public const ARTIFACT_DIR = 'storage/app/market-data/evidence/MD-B17-A002';
    ...
    public static function validate(string $root): array
    {
        ...
        return [
            'gate' => 'MarketDataReadProductClosureGate',
            'stage_id' => $spec::STAGE,
...
if (realpath(isset($_SERVER['SCRIPT_FILENAME']) ? $_SERVER['SCRIPT_FILENAME'] : '') === __FILE__) {
    $result = MarketDataReadProductClosureGate::validate(dirname(__DIR__, 5));
