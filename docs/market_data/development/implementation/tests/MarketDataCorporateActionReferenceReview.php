...
/**
 * Governed MD-B11-A002 scoped reference-population re-check. Usage: php this-file.php [--apply].
 *
 * A002 takes the high-severity subset: `Forbidden behavior (LOCKED)` and
 ...
 * stage is finished, and MD-B11 stays outside DECISION_RECORDED_STAGES until A003 lands.
 *
...
echo json_encode([
    ...
    'scope' => 'four prohibition sections plus the verification and effective-date hierarchies',
