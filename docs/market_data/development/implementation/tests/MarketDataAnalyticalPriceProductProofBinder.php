...
if(!$evidence||!preg_match('/^E-MD-B12-A00[123]-\d{3}$/',$evidence))throw new RuntimeException('Use --validate-only or --evidence-id=E-MD-B12-A00[1|2]-NNN [--apply].');
...
$__a002=array_keys(MarketDataAnalyticalPriceProductTraceabilitySpec::REMEDIATED_RULES);
$__a003=array_keys(MarketDataAnalyticalPriceProductTraceabilitySpec::A003_REMEDIATED_RULES);
$__which=strpos($evidence,'E-MD-B12-A003-')===0?'A003':(strpos($evidence,'E-MD-B12-A002-')===0?'A002':'A001');
$boundToThisAttempt=$__which==='A003'?$__a003:($__which==='A002'?$__a002:array_merge($__a002,$__a003));
$isA002=$__which!=='A001';
