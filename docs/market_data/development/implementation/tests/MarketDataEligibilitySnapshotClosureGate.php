...
/**
 * `MD-B16` stage-closure condition gate.
 *
 ...
 */
final class MarketDataEligibilitySnapshotClosureGate
{
    public const EVIDENCE = 'E-MD-B16-A001-001';

    public const ARTIFACT_DIR = 'storage/app/market-data/evidence/MD-B16-A001';
    ...
    public static function validate(string $root): array
    {
        ...
        return [
            'gate' => 'MarketDataEligibilitySnapshotClosureGate',
            'stage_id' => $spec::STAGE,
...
if (realpath(isset($_SERVER['SCRIPT_FILENAME']) ? $_SERVER['SCRIPT_FILENAME'] : '') === __FILE__) {
    $result = MarketDataEligibilitySnapshotClosureGate::validate(dirname(__DIR__, 5));
