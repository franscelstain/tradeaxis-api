...
/**
 * Falsifiability control for the `MD-B14` proof gate.
 *
...
$fails = static function (array $overrides) use ($root, $bound) {
    return MarketDataIndicatorEngineProofGate::validate($root, $bound, $overrides)['status'] === 'FAIL';
};

$checks = [];
$checks[$bound ? 'control_bound' : 'control_prebinding'] =
    MarketDataIndicatorEngineProofGate::validate($root, $bound)['status'] === 'PASS';
...
$result = [
    'gate' => 'MarketDataIndicatorEngineProofSelfTest',
    'stage_id' => $spec::STAGE,
