...
class RunBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationReadinessReviewCommand extends Command
{
    protected $signature = 'watchlist:backtest-c163-weekly-swing-watchlist-production-live-runtime-plan-confirm-completion-post-handoff-activation-readiness-review
        {--c163-post-handoff-boundary-artifact=storage/app/watchlist/backtest/c163-weekly-swing-watchlist-production-live-runtime-plan-confirm-completion-post-handoff-boundary-review.json}
        {--expected-c163-post-handoff-boundary-hash=e0cb142d4a075acefb89e5a6f0a367e090ec190d}
        {--expected-c163-post-handoff-boundary-file-sha1=986469AFAC7F1349A77F4FD1712AB2272CC6E37A}
        {--approval-reference=}
        {--output=storage/app/watchlist/backtest/c163-weekly-swing-watchlist-production-live-runtime-plan-confirm-completion-post-handoff-activation-readiness-review.json}
        {--operator-approved}
    ...
    protected $description = 'Run C163 weekly swing watchlist production/live runtime PLAN/CONFIRM completion post-handoff activation readiness review.';

    private WatchlistBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationReadinessReviewService $service;

    public function __construct(?WatchlistBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationReadinessReviewService $service = null)
    {
        parent::__construct();
        $this->service = $service ?: new WatchlistBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationReadinessReviewService();
    }

    public function handle(): int
    {
        if ((bool) $this->option('progress')) {
            $this->line('C163 weekly swing watchlist production/live runtime PLAN/CONFIRM completion post-handoff activation readiness review started');
        }

        $result = $this->service->execute(
            (string) $this->option('c163-post-handoff-boundary-artifact'),
            (string) $this->option('expected-c163-post-handoff-boundary-hash'),
            (string) $this->option('expected-c163-post-handoff-boundary-file-sha1'),
            ...
            [
                ...
                'c163_post_handoff_boundary_complete_confirmed' => (bool) $this->option('c163-post-handoff-boundary-complete-confirmed'),
        ...
        foreach ([
            ...
            'expected_c163_post_handoff_boundary_hash', 'actual_c163_post_handoff_boundary_hash', 'c163_post_handoff_boundary_hash_match',
            'expected_c163_post_handoff_boundary_file_sha1', 'actual_c163_post_handoff_boundary_file_sha1', 'c163_post_handoff_boundary_file_sha1_match',
        ...
        if (strpos((string) ($result['status'] ?? ''), 'C163_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_PLAN_CONFIRM_COMPLETION_POST_HANDOFF_ACTIVATION_READINESS_REVIEW_PASSED') === 0) {
            if ((bool) $this->option('progress')) {
                $this->line('C163 weekly swing watchlist production/live runtime PLAN/CONFIRM completion post-handoff activation readiness review completed');
            }
