...
class SeedBacktestC05ParamGridCommand extends Command
{
    protected $signature = 'watchlist:backtest-c05-param-grid-seed';

    protected $description = 'Seed immutable deterministic Weekly Swing downside/stability C05 catalog without mutating R1/R2/C01/C02/C03/C04.';
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $this->assertHistoricalCatalogsIntact($r1Before, $r2Before, $c01Before, $c02Before, $c03Before, $c04Before);

            $result = $repository->seedCatalog(WatchlistBacktestC05ParamGridCatalog::rows());
            ...
            if ($r1Before !== $r1After || $r2Before !== $r2After || $c01Before !== $c01After
                ...
                throw new \RuntimeException('WS_BT_R1_MUTATION_REJECTED: historical R1/R2/C01/C02/C03/C04 snapshot changed during C05 seed.');
            }
        } catch (\Throwable $e) {
        ...
        $this->line('catalog_code='.WatchlistBacktestC05ParamGridCatalog::CATALOG_CODE);
        $this->line('catalog_version='.WatchlistBacktestC05ParamGridCatalog::CATALOG_VERSION);
        $this->line('catalog_count='.WatchlistBacktestC05ParamGridCatalog::CATALOG_COUNT);
        $this->line('catalog_hash='.WatchlistBacktestC05ParamGridCatalog::hash());
    ...
    private function assertHistoricalCatalogsIntact(array $r1, array $r2, array $c01, array $c02, array $c03, array $c04): void
    {
        if ((int) $r1['catalog_count'] !== WatchlistBacktestParamGridCatalog::CATALOG_COUNT
            ...
            throw new \RuntimeException('WS_BT_R1_MUTATION_REJECTED: R1 must exist with its immutable count/hash before C05 can be seeded.');
        }
        if ((int) $r2['catalog_count'] !== WatchlistBacktestR2ParamGridCatalog::CATALOG_COUNT
            ...
            throw new \RuntimeException('WS_BT_R2_CATALOG_PERSISTED_SET_MISMATCH: R2 must exist with its immutable count/hash before C05 can be seeded.');
        }
        if ((int) $c01['catalog_count'] !== WatchlistBacktestC01ParamGridCatalog::CATALOG_COUNT
            ...
            throw new \RuntimeException('WS_BT_R2_CATALOG_PERSISTED_SET_MISMATCH: C01 must exist with its immutable count/hash before C05 can be seeded.');
        }
        if ((int) $c02['catalog_count'] !== WatchlistBacktestC02ParamGridCatalog::CATALOG_COUNT
            ...
            throw new \RuntimeException('WS_BT_R2_CATALOG_PERSISTED_SET_MISMATCH: C02 must exist with its immutable count/hash before C05 can be seeded.');
        }
        if ((int) $c03['catalog_count'] !== WatchlistBacktestC03ParamGridCatalog::CATALOG_COUNT
            ...
            throw new \RuntimeException('WS_BT_R2_CATALOG_PERSISTED_SET_MISMATCH: C03 must exist with its immutable count/hash before C05 can be seeded.');
        }
        if ((int) $c04['catalog_count'] !== WatchlistBacktestC04ParamGridCatalog::CATALOG_COUNT
            ...
            throw new \RuntimeException('WS_BT_R2_CATALOG_PERSISTED_SET_MISMATCH: C04 must exist with its immutable count/hash before C05 can be seeded.');
        }
    }
