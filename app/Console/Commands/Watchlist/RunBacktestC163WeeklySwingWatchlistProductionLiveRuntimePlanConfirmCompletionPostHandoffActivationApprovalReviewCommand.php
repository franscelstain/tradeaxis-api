...
class RunBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationApprovalReviewCommand extends Command
{
    protected $signature = 'watchlist:backtest-c163-weekly-swing-watchlist-production-live-runtime-plan-confirm-completion-post-handoff-activation-approval-review
        {--c163-post-handoff-activation-readiness-artifact=storage/app/watchlist/backtest/c163-weekly-swing-watchlist-production-live-runtime-plan-confirm-completion-post-handoff-activation-readiness-review.json}
        {--expected-c163-post-handoff-activation-readiness-hash=2ade4f45972d1675eb2be1c222bc688d0c454b3b}
        {--expected-c163-post-handoff-activation-readiness-file-sha1=17BA06C16DC071B38643D8F502C2D22808725A72}
        {--approval-reference=}
        {--output=storage/app/watchlist/backtest/c163-weekly-swing-watchlist-production-live-runtime-plan-confirm-completion-post-handoff-activation-approval-review.json}
        {--operator-approved}
    ...
    protected $description = 'Run C163 weekly swing watchlist production/live runtime PLAN/CONFIRM completion post-handoff activation approval review.';

    private WatchlistBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationApprovalReviewService $service;

    public function __construct(?WatchlistBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationApprovalReviewService $service = null)
    {
        parent::__construct();
        $this->service = $service ?: new WatchlistBacktestC163WeeklySwingWatchlistProductionLiveRuntimePlanConfirmCompletionPostHandoffActivationApprovalReviewService();
    }

    public function handle(): int
    {
        if ((bool) $this->option('progress')) {
            $this->line('C163 weekly swing watchlist production/live runtime PLAN/CONFIRM completion post-handoff activation approval review started');
        }

        $result = $this->service->execute(
            (string) $this->option('c163-post-handoff-activation-readiness-artifact'),
            (string) $this->option('expected-c163-post-handoff-activation-readiness-hash'),
            (string) $this->option('expected-c163-post-handoff-activation-readiness-file-sha1'),
            ...
            [
                ...
                'c163_post_handoff_activation_readiness_complete_confirmed' => (bool) $this->option('c163-post-handoff-activation-readiness-complete-confirmed'),
                'post_handoff_activation_readiness_confirmed' => (bool) $this->option('post-handoff-activation-readiness-confirmed'),
        ...
        foreach ([
            ...
            'expected_c163_post_handoff_activation_readiness_hash', 'actual_c163_post_handoff_activation_readiness_hash', 'c163_post_handoff_activation_readiness_hash_match',
            'expected_c163_post_handoff_activation_readiness_file_sha1', 'actual_c163_post_handoff_activation_readiness_file_sha1', 'c163_post_handoff_activation_readiness_file_sha1_match',
        ...
        if (strpos((string) ($result['status'] ?? ''), 'C163_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_PLAN_CONFIRM_COMPLETION_POST_HANDOFF_ACTIVATION_APPROVAL_REVIEW_PASSED') === 0) {
            if ((bool) $this->option('progress')) {
                $this->line('C163 weekly swing watchlist production/live runtime PLAN/CONFIRM completion post-handoff activation approval review completed');
            }
