...
/**
 * Isolated non-live C71 shadow-read validation contract.
 * This contract is intentionally not consumed by PLAN/CONFIRM runtime services.
 */
class WatchlistProductionCatalogShadowReadRuntimeValidationContract
{
    public const FEATURE_FLAG = 'watchlist.production_catalog_shadow_read_enabled';
