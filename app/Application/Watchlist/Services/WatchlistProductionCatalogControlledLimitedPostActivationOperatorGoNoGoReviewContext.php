...
/**
 * Explicit-only C87 post-activation operator go/no-go context.
 * Not persisted to config, DB, or live runtime; artifact-only operator decision.
 */
class WatchlistProductionCatalogControlledLimitedPostActivationOperatorGoNoGoReviewContext
{
    public const CONTEXT_CODE = 'C87_CONTROLLED_LIMITED_POST_ACTIVATION_OPERATOR_GO_NO_GO_REVIEW_CONTEXT';
    ...
    public const RECORDS_POST_ACTIVATION_OPERATOR_GO_NO_GO = true;
    ...
    public static function build(string $approvalReference): array
    {
        return [
            ...
            'records_post_activation_operator_go_no_go' => self::RECORDS_POST_ACTIVATION_OPERATOR_GO_NO_GO,
