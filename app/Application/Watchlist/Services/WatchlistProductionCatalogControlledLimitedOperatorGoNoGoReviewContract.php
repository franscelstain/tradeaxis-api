...
/**
 * C80 artifact-only contract for controlled limited operator go/no-go review.
 ...
 */
class WatchlistProductionCatalogControlledLimitedOperatorGoNoGoReviewContract
{
    public const CONTRACT_CODE = 'C80_CONTROLLED_LIMITED_OPERATOR_GO_NO_GO_REVIEW_CONTRACT';
    ...
    public const OPERATOR_GO_NO_GO_REVIEW_ONLY = true;
    ...
    public static function summary(): array
    {
        return [
            ...
            'operator_go_no_go_review_only' => self::OPERATOR_GO_NO_GO_REVIEW_ONLY,
