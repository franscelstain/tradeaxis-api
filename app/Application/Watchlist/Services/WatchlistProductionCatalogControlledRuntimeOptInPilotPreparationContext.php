...
/**
 * Explicit-only C76 pilot preparation context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledRuntimeOptInPilotPreparationContext
{
    public const CONTEXT_CODE = 'C76_CONTROLLED_RUNTIME_OPT_IN_PILOT_PREPARATION_CONTEXT';
