...
/**
 * Explicit-only C77 shadow rollout execution review context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledShadowRolloutExecutionReviewContext
{
    public const CONTEXT_CODE = 'C77_CONTROLLED_SHADOW_ROLLOUT_EXECUTION_REVIEW_CONTEXT';
