...
/**
 * C76 artifact-only contract for controlled shadow rollout preparation.
 ...
 */
class WatchlistProductionCatalogControlledShadowRolloutPreparationContract
{
    public const CONTRACT_CODE = 'C76_CONTROLLED_SHADOW_ROLLOUT_PREPARATION_CONTRACT';
