...
/**
 * C78 artifact-only contract for controlled limited runtime opt-in pilot observation review.
 ...
 */
class WatchlistProductionCatalogControlledLimitedRuntimeOptInPilotObservationReviewContract
{
    public const CONTRACT_CODE = 'C78_CONTROLLED_LIMITED_RUNTIME_OPT_IN_PILOT_OBSERVATION_REVIEW_CONTRACT';
    ...
    public const OBSERVATION_REVIEW_ONLY = true;
    ...
    public static function summary(): array
    {
        return [
            ...
            'observation_review_only' => self::OBSERVATION_REVIEW_ONLY,
