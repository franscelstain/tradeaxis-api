...
/**
 * Explicit-only C84 activation execution review context.
 * Not persisted to config, DB, or live runtime; artifact-only controlled record.
 */
class WatchlistProductionCatalogControlledLimitedActivationExecutionReviewContext
{
    public const CONTEXT_CODE = 'C84_CONTROLLED_LIMITED_ACTIVATION_EXECUTION_REVIEW_CONTEXT';
    ...
    public const CREATES_CONTROLLED_ACTIVATION_RECORD = true;
    public const EXECUTES_ACTIVATION_RECORD_ONLY = true;
    ...
    public static function build(string $approvalReference): array
    {
        return [
            ...
            'creates_controlled_activation_record' => self::CREATES_CONTROLLED_ACTIVATION_RECORD,
            'executes_activation_record_only' => self::EXECUTES_ACTIVATION_RECORD_ONLY,
