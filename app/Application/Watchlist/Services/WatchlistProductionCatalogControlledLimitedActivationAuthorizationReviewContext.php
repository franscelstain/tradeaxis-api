...
/**
 * Explicit-only C83 activation authorization review context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledLimitedActivationAuthorizationReviewContext
{
    public const CONTEXT_CODE = 'C83_CONTROLLED_LIMITED_ACTIVATION_AUTHORIZATION_REVIEW_CONTEXT';
    ...
    public const AUTHORIZES_ACTIVATION_ARTIFACT_ONLY = true;
    public const EXECUTES_ACTIVATION = false;
    ...
    public static function build(string $approvalReference): array
    {
        return [
            ...
            'authorizes_activation_artifact_only' => self::AUTHORIZES_ACTIVATION_ARTIFACT_ONLY,
            'executes_activation' => self::EXECUTES_ACTIVATION,
