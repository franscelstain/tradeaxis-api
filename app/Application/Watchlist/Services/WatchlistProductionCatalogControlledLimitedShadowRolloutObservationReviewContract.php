...
/**
 * C78 artifact-only contract for controlled limited shadow rollout observation review.
 ...
 */
class WatchlistProductionCatalogControlledLimitedShadowRolloutObservationReviewContract
{
    public const CONTRACT_CODE = 'C78_CONTROLLED_LIMITED_SHADOW_ROLLOUT_OBSERVATION_REVIEW_CONTRACT';
