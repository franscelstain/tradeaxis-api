...
/**
 * Explicit-only C78 limited pilot observation review context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledLimitedRuntimeOptInPilotObservationReviewContext
{
    public const CONTEXT_CODE = 'C78_CONTROLLED_LIMITED_RUNTIME_OPT_IN_PILOT_OBSERVATION_REVIEW_CONTEXT';
