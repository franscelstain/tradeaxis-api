...
/**
 * C79 artifact-only contract for controlled limited runtime opt-in pilot observation result review.
 ...
 */
class WatchlistProductionCatalogControlledLimitedRuntimeOptInPilotObservationResultReviewContract
{
    public const CONTRACT_CODE = 'C79_CONTROLLED_LIMITED_RUNTIME_OPT_IN_PILOT_OBSERVATION_RESULT_REVIEW_CONTRACT';
    ...
    public const OBSERVATION_RESULT_REVIEW_ONLY = true;
    ...
    public static function summary(): array
    {
        return [
            ...
            'observation_result_review_only' => self::OBSERVATION_RESULT_REVIEW_ONLY,
