...
/**
 * Explicit-only C85 post-activation observation review context.
 * Not persisted to config, DB, or live runtime; artifact-only observation record.
 */
class WatchlistProductionCatalogControlledLimitedPostActivationObservationReviewContext
{
    public const CONTEXT_CODE = 'C85_CONTROLLED_LIMITED_POST_ACTIVATION_OBSERVATION_REVIEW_CONTEXT';
    ...
    public const OBSERVES_CONTROLLED_ACTIVATION_RECORD = true;
    ...
    public static function build(string $approvalReference): array
    {
        return [
            ...
            'observes_controlled_activation_record' => self::OBSERVES_CONTROLLED_ACTIVATION_RECORD,
