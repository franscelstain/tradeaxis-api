...
/**
 * Explicit-only C80 operator go/no-go review context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledLimitedOperatorGoNoGoReviewContext
{
    public const CONTEXT_CODE = 'C80_CONTROLLED_LIMITED_OPERATOR_GO_NO_GO_REVIEW_CONTEXT';
