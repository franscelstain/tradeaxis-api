...
/**
 * Explicit-only C81 GO decision finalization review context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledLimitedGoDecisionFinalizationReviewContext
{
    public const CONTEXT_CODE = 'C81_CONTROLLED_LIMITED_GO_DECISION_FINALIZATION_REVIEW_CONTEXT';
