...
/**
 * C79 artifact-only contract for controlled limited shadow rollout observation result review.
 ...
 */
class WatchlistProductionCatalogControlledLimitedShadowRolloutObservationResultReviewContract
{
    public const CONTRACT_CODE = 'C79_CONTROLLED_LIMITED_SHADOW_ROLLOUT_OBSERVATION_RESULT_REVIEW_CONTRACT';
