...
/**
 * C77 artifact-only contract for controlled runtime opt-in pilot execution review.
 ...
 */
class WatchlistProductionCatalogControlledRuntimeOptInPilotExecutionReviewContract
{
    public const CONTRACT_CODE = 'C77_CONTROLLED_RUNTIME_OPT_IN_PILOT_EXECUTION_REVIEW_CONTRACT';
    ...
    public const EXECUTION_REVIEW_ONLY = true;
    ...
    public static function summary(): array
    {
        return [
            ...
            'execution_review_only' => self::EXECUTION_REVIEW_ONLY,
