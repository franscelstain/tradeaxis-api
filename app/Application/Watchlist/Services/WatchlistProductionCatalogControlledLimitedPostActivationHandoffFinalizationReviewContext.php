...
/**
 * Explicit-only C91 post-activation handoff finalization review context.
 * Not persisted to config, DB, or live runtime; artifact-only handoff finalization proof.
 */
class WatchlistProductionCatalogControlledLimitedPostActivationHandoffFinalizationReviewContext
{
    public const CONTEXT_CODE = 'C91_CONTROLLED_LIMITED_POST_ACTIVATION_HANDOFF_FINALIZATION_REVIEW_CONTEXT';
    ...
    public const MARKS_POST_ACTIVATION_HANDOFF_FINALIZED = true;
    ...
    public static function build(string $approvalReference): array
    {
        return [
            ...
            'marks_post_activation_handoff_finalized' => self::MARKS_POST_ACTIVATION_HANDOFF_FINALIZED,
