...
class WatchlistBacktestC144WeeklySwingWatchlistProductionLiveRuntimeActivationPreActivationBoundaryReviewService
{
    public const RUN_CODE = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW';
    public const PHASE_LABEL = 'PR-32 / C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW';
    public const ARTIFACT_TYPE = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW';

    public const DEFAULT_C143_ARTIFACT = 'storage/app/watchlist/backtest/c143-weekly-swing-watchlist-production-live-runtime-activation-go-decision-finalization-review.json';
    public const DEFAULT_EXPECTED_C143_HASH = '804b6020e73e24e7dac0a9ecbbe116ff5ee95808';
    public const DEFAULT_EXPECTED_C143_FILE_SHA1 = 'F0645B69E7F22C1FACEEA235ED0256777558752F';
    public const DEFAULT_OUTPUT_PATH = 'storage/app/watchlist/backtest/c144-weekly-swing-watchlist-production-live-runtime-activation-pre-activation-boundary-review.json';

    private const PRIMARY_CANDIDATE = 'C61_E02_B01_HYBRID_ALL_GUARDS_PRELOCK_CANDIDATE';
    private const BACKUP_CANDIDATE = 'C61_B01_A02_MARKET_SECTOR_DEFENSIVE_CONFIRMATION';
    private const COMPARATOR_CANDIDATE = 'C61_A01_B01_WEAK_REGIME_QUALITY_FIRST';

    private const EXPECTED_C143_STATUS = 'C143_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_GO_DECISION_FINALIZATION_REVIEW_PASSED_FINALIZED_GO_PRIMARY_AND_BACKUP';
    private const EXPECTED_C143_PHASE_LABEL = 'PR-31 / C143_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_GO_DECISION_FINALIZATION_REVIEW';
    private const EXPECTED_C143_NEXT_RECOMMENDATION = self::RUN_CODE;
    private const C145_RECOMMENDATION = 'C145_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_AUTHORIZATION_REVIEW';

    private const PASS_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_PASSED_BOUNDARY_CLEARED_PRIMARY_AND_BACKUP';
    private const APPROVAL_MISSING_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_OPERATOR_APPROVAL_MISSING';
    private const BOUNDARY_NOT_CONFIRMED_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_PRE_ACTIVATION_BOUNDARY_NOT_CONFIRMED';
    private const TEMPORARY_NEGATIVE_REMAINS_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_TEMPORARY_NEGATIVE_ARTIFACT_REMAINS';
    private const C143_LOCK_MISMATCH_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_ARTIFACT_LOCK_MISMATCH';
    private const C143_FILE_SHA1_MISMATCH_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_FILE_SHA1_LOCK_MISMATCH';
    private const C143_STATUS_MISMATCH_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_STATUS_MISMATCH';
    private const C143_PHASE_LABEL_MISMATCH_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_PHASE_LABEL_MISMATCH';
    private const C143_NEXT_RECOMMENDATION_MISMATCH_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_NEXT_RECOMMENDATION_MISMATCH';
    private const C143_GO_DECISION_INVALID_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_GO_DECISION_FINALIZATION_INVALID';
    private const C143_CONVERT_FROM_JSON_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_C143_CONVERT_FROM_JSON_COMPATIBILITY_VIOLATION';
    private const CANDIDATE_SCOPE_MISMATCH_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_CANDIDATE_SCOPE_MISMATCH';
    private const LIVE_OR_PRODUCTION_MUTATION_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_LIVE_OR_PRODUCTION_MUTATION_ATTEMPT';
    private const FEATURE_FLAG_NOT_DEFAULT_OFF_STATUS = 'C144_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW_REJECTED_FEATURE_FLAGS_NOT_DEFAULT_OFF';

    private const REQUIRED_C143_TRUE_FIELDS = [
        ...
        'c143_not_live_runtime_state_change',
    ...
    private const REQUIRED_C143_FALSE_FIELDS = [
    ...
    public function execute(
        string $c143Artifact = self::DEFAULT_C143_ARTIFACT,
        string $expectedC143Hash = self::DEFAULT_EXPECTED_C143_HASH,
        string $expectedC143FileSha1 = self::DEFAULT_EXPECTED_C143_FILE_SHA1,
        string $outputPath = self::DEFAULT_OUTPUT_PATH,
        array $options = []
    ): array {
        $overwrite = (bool) ($options['overwrite'] ?? false);
        $artifact = $this->baseArtifact((string) ($options['created_at'] ?? gmdate('c')));
        $load = $this->loadArtifactLock($c143Artifact, $expectedC143Hash, $expectedC143FileSha1);
        $artifact['source_artifact_locks'] = $this->sourceArtifactLocks($load);
        $artifact = array_merge($artifact, $this->topLevelLockAliases($load));

        if (! $load['exists'] || ! is_array($load['payload'])) {
            return $this->blocked($artifact, self::C143_LOCK_MISMATCH_STATUS, 'C143 artifact missing or unreadable.', $outputPath, $overwrite);
        }
        if (! $load['convert_from_json_pass']) {
            $artifact = $this->completeSections($artifact, $load, $options, false);
            $artifact['c143_convert_from_json_duplicate_keys'] = $load['case_insensitive_duplicate_keys'];

            return $this->rejected($artifact, self::C143_CONVERT_FROM_JSON_STATUS, 'C143 artifact is not PowerShell ConvertFrom-Json compatible.', $outputPath, $overwrite);
        }
        if (! $load['hash_match']) {
            return $this->blocked($artifact, self::C143_LOCK_MISMATCH_STATUS, 'C143 artifact_hash mismatch.', $outputPath, $overwrite);
        }
        if (! $load['file_sha1_match']) {
            return $this->blocked($artifact, self::C143_FILE_SHA1_MISMATCH_STATUS, 'C143 file SHA1 mismatch.', $outputPath, $overwrite);
        }

        $c143 = $load['payload'];
        if (($c143['status'] ?? null) !== self::EXPECTED_C143_STATUS || ($c143['reason_code'] ?? null) !== self::EXPECTED_C143_STATUS) {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::C143_STATUS_MISMATCH_STATUS, 'C143 status/reason is not pre-activation boundary ready.', $outputPath, $overwrite);
        }
        if (($c143['phase_label'] ?? null) !== self::EXPECTED_C143_PHASE_LABEL) {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::C143_PHASE_LABEL_MISMATCH_STATUS, 'C143 phase label mismatch.', $outputPath, $overwrite);
        }
        if (! $this->c143NextRecommendationMatches($c143)) {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::C143_NEXT_RECOMMENDATION_MISMATCH_STATUS, 'C143 next recommendation is not C144.', $outputPath, $overwrite);
        }
        if (! $this->c143GoDecisionFinalizationValid($c143)) {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::C143_GO_DECISION_INVALID_STATUS, 'C143 production/live activation GO decision finalization evidence is incomplete.', $outputPath, $overwrite);
        }
        if (! $this->candidateScopeMatches($c143)) {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::CANDIDATE_SCOPE_MISMATCH_STATUS, 'C143 candidate scope does not match locked pre-activation boundary scope.', $outputPath, $overwrite);
        }

        $safetyFailure = $this->firstLiveOrMutatingSafetyFlag($c143);
        if ($safetyFailure !== null) {
            $artifact = $this->completeSections($artifact, $load, $options, false);
            $artifact['c143_live_or_mutating_safety_flag_failure'] = $safetyFailure;

            return $this->rejected($artifact, self::LIVE_OR_PRODUCTION_MUTATION_STATUS, 'C143 contains live, mutating, production, or weekly-live flag set to true.', $outputPath, $overwrite);
        }
        if ($this->enabledRuntimeFeatureFlags() !== []) {
            $artifact = $this->completeSections($artifact, $load, $options, false);
            $artifact['enabled_runtime_feature_flags'] = $this->enabledRuntimeFeatureFlags();

            return $this->rejected($artifact, self::FEATURE_FLAG_NOT_DEFAULT_OFF_STATUS, 'C144 requires runtime feature flags to remain default-off.', $outputPath, $overwrite);
        }
        if (! (bool) ($options['operator_approved'] ?? false) || trim((string) ($options['approval_reference'] ?? '')) === '') {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::APPROVAL_MISSING_STATUS, 'C144 requires --operator-approved and non-empty --approval-reference.', $outputPath, $overwrite);
        }
        if (($options['pre_activation_boundary_confirmed'] ?? true) !== true) {
            return $this->rejected($this->completeSections($artifact, $load, $options, false), self::BOUNDARY_NOT_CONFIRMED_STATUS, 'C144 requires explicit pre-activation boundary confirmation.', $outputPath, $overwrite);
        }
        ...
        $artifact['message'] = 'C144 clears the production/live runtime activation pre-activation boundary for E02 primary and B01 backup. This is still artifact-only and does not authorize activation, activate runtime bridge, execute live output, publish recommendations, or mutate PLAN/CONFIRM.';
        $artifact['diagnostic_conclusion'] = 'READY_FOR_C145_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_AUTHORIZATION_REVIEW';
        $artifact['next_step_recommendation'] = self::C145_RECOMMENDATION;
    ...
    private function baseArtifact(string $createdAt): array
    {
        return array_merge(array_fill_keys(self::REQUIRED_FALSE_SAFETY_FLAGS, false), [
            ...
            'phase_checkpoint' => 'PR-32',
            'internal_checkpoint' => 'C144',
            'status' => 'C144_NOT_RUN',
            'reason_code' => 'C144_NOT_RUN',
            ...
            'c144_not_live_runtime_state_change' => true,
    ...
    {
        $c143 = is_array($load['payload']) ? $load['payload'] : [];
        $temporaryNegativePaths = (array) ($options['temporary_negative_artifact_paths'] ?? []);

        return array_merge($artifact, [
            'c143_lock_validation_summary' => $this->c143LockValidationSummary($load),
            'c143_go_decision_finalization_carry_forward_summary' => $this->c143GoDecisionFinalizationCarryForwardSummary($c143),
            'candidate_scope_freeze_summary' => $this->candidateScopeFreezeSummary($c143, $pass),
            ...
            'c144_pre_activation_boundary_decision' => $this->preActivationBoundaryDecision($pass),
            ...
            'c144_candidate_activation_authorization_readiness_scorecard' => $this->candidateScorecard($pass),
    ...
    private function c143LockValidationSummary(array $load): array
    {
        $c143 = is_array($load['payload']) ? $load['payload'] : [];
        ...
        return [
            ...
            'expected_status' => self::EXPECTED_C143_STATUS,
            'actual_status' => $c143['status'] ?? null,
            'expected_phase_label' => self::EXPECTED_C143_PHASE_LABEL,
            'actual_phase_label' => $c143['phase_label'] ?? null,
            'expected_next_recommendation' => self::EXPECTED_C143_NEXT_RECOMMENDATION,
            'next_recommendation_match' => $this->c143NextRecommendationMatches($c143),
            'c143_lock_valid' => $load['hash_match'] && $load['file_sha1_match'] && $load['convert_from_json_pass'],
        ];
    }

    private function c143GoDecisionFinalizationCarryForwardSummary(array $c143): array
    {
        return [
            'validation_completed' => true,
            'c143_go_decision_finalization_review_pass' => (bool) ($c143['weekly_swing_watchlist_production_live_runtime_activation_go_decision_finalization_review_pass'] ?? false),
            'c143_operator_go_decision' => (string) ($c143['operator_go_decision'] ?? ''),
            'c143_operator_go_decision_confirmed' => (bool) ($c143['operator_go_decision_confirmed'] ?? false),
            'c143_go_decision_finalized' => (bool) ($c143['go_decision_finalized'] ?? false),
            'c143_go_decision_finalization_confirmed' => (bool) ($c143['go_decision_finalization_confirmed'] ?? false),
            'c143_ready_for_pre_activation_boundary_review' => (bool) ($c143['ready_for_production_live_runtime_activation_pre_activation_boundary_review'] ?? false),
            'c142_lock_valid' => (bool) ($c143['c142_lock_valid'] ?? false),
            'c142_activation_operator_go_no_go_valid' => (bool) ($c143['c142_activation_operator_go_no_go_valid'] ?? false),
            'c142_convert_from_json_pass' => (bool) ($c143['c142_convert_from_json_pass'] ?? false),
            'c141_activation_observation_result_review_valid' => (bool) ($c143['c141_activation_observation_result_review_valid'] ?? false),
            'c140_activation_observation_review_valid' => (bool) ($c143['c140_activation_observation_review_valid'] ?? false),
            'c139_activation_execution_review_valid' => (bool) ($c143['c139_activation_execution_review_valid'] ?? false),
            'c138_activation_authorization_valid' => (bool) ($c143['c138_activation_authorization_valid'] ?? false),
            'c137_pre_activation_boundary_valid' => (bool) ($c143['c137_pre_activation_boundary_valid'] ?? false),
            'c136_go_decision_finalization_valid' => (bool) ($c143['c136_go_decision_finalization_valid'] ?? false),
            'c135_activation_operator_go_no_go_valid' => (bool) ($c143['c135_activation_operator_go_no_go_valid'] ?? false),
            'c134_activation_observation_result_review_valid' => (bool) ($c143['c134_activation_observation_result_review_valid'] ?? false),
            'c133_activation_observation_review_valid' => (bool) ($c143['c133_activation_observation_review_valid'] ?? false),
            'c132_activation_execution_review_valid' => (bool) ($c143['c132_activation_execution_review_valid'] ?? false),
            'c131_activation_approval_valid' => (bool) ($c143['c131_activation_approval_valid'] ?? false),
            'c130_activation_readiness_valid' => (bool) ($c143['c130_activation_readiness_valid'] ?? false),
            'c129_final_closure_valid' => (bool) ($c143['c129_final_closure_valid'] ?? false),
            'activation_authorized' => (bool) ($c143['activation_authorized'] ?? false),
            'primary_candidate_activation_authorized' => (bool) ($c143['primary_candidate_activation_authorized'] ?? false),
            'backup_candidate_activation_authorized' => (bool) ($c143['backup_candidate_activation_authorized'] ?? false),
            'comparator_candidate_activation_authorized' => (bool) ($c143['comparator_candidate_activation_authorized'] ?? false),
            'c143_go_decision_finalization_valid' => $this->c143GoDecisionFinalizationValid($c143),
            'c144_pre_activation_boundary_can_start' => $this->c143GoDecisionFinalizationValid($c143),
        ];
    }

    private function candidateScopeFreezeSummary(array $c143, bool $pass): array
    {
        return [
            'candidate_scope_locked' => true,
            'candidate_scope_valid' => $this->candidateScopeMatches($c143),
            'primary_candidate_code' => self::PRIMARY_CANDIDATE,
            'backup_candidate_code' => self::BACKUP_CANDIDATE,
            'comparator_candidate_code' => self::COMPARATOR_CANDIDATE,
    ...
    private function preActivationBoundaryDecision(bool $pass): array
    {
        return [
            ...
            'weekly_swing_watchlist_live_output_enabled' => false,
            'weekly_swing_watchlist_live_recommendation_generated' => false,
            'next_recommendation' => $pass ? self::C145_RECOMMENDATION : 'C144_TARGETED_C143_GO_DECISION_FINALIZATION_REPAIR',
            'decision_reason' => $pass ? 'C144 clears the artifact-only pre-activation boundary and permits activation authorization review next.' : 'C144 cannot proceed until C143 lock, approval, boundary confirmation, cleanup, candidate, and safety gates pass.',
        ];
    }
    ...
    private function nextActivationAuthorizationDecision(bool $pass): array
    {
        return [
            'review_pass' => $pass,
            'next_recommendation' => $pass ? self::C145_RECOMMENDATION : 'C144_TARGETED_C143_GO_DECISION_FINALIZATION_REPAIR',
            'next_scope' => $pass ? 'production/live runtime activation authorization review only; C144 itself still does not authorize activation, activate runtime bridge, generate live output, publish recommendations, or mutate PLAN/CONFIRM' : 'targeted C143 GO decision finalization lock, approval, or safety repair only',
        ];
    }
    ...
    private function preActivationBoundaryManifest(array $load, bool $pass): array
    {
        return [
            ...
            'source_artifact' => 'C143_WEEKLY_SWING_WATCHLIST_PRODUCTION_LIVE_RUNTIME_ACTIVATION_GO_DECISION_FINALIZATION_REVIEW',
    ...
    private function preActivationBoundaryChecklist(): array
    {
        return [
            ...
            'c143_source_lock_reviewed' => true,
    ...
    private function candidateScorecard(bool $pass): array
    {
        ...
        return [
            array_merge($base, [
                ...
                'c144_role' => 'primary_production_live_runtime_activation_pre_activation_boundary_cleared_candidate',
                'primary_candidate_ready_for_production_live_runtime_activation_authorization_review' => $pass,
            ]),
            array_merge($base, [
                'candidate_code' => self::BACKUP_CANDIDATE,
                'c144_role' => 'backup_production_live_runtime_activation_pre_activation_boundary_cleared_candidate',
                'backup_candidate_ready_for_production_live_runtime_activation_authorization_review' => $pass,
            ]),
            array_merge($base, [
                'candidate_code' => self::COMPARATOR_CANDIDATE,
                'c144_role' => 'comparator_only_candidate',
                'production_live_runtime_activation_pre_activation_boundary_review_pass' => false,
                'pre_activation_boundary_cleared' => false,
                'ready_for_production_live_runtime_activation_authorization_review' => false,
                'comparator_candidate_ready_for_production_live_runtime_activation_authorization_review' => false,
    ...
    private function runtimeConfigReviewSummary(): array
    {
        return [
            ...
            'production_config_default_unchanged' => true,
            'c143_artifact_identified' => is_file(self::DEFAULT_C143_ARTIFACT),
            'c144_service_identified' => is_file('app/Application/Watchlist/Services/WatchlistBacktestC144WeeklySwingWatchlistProductionLiveRuntimeActivationPreActivationBoundaryReviewService.php'),
            'c144_command_identified' => is_file('app/Console/Commands/Watchlist/RunBacktestC144WeeklySwingWatchlistProductionLiveRuntimeActivationPreActivationBoundaryReviewCommand.php'),
    ...
    {
        return [
            'progress_marker' => 'PR-32_C144_PRODUCTION_LIVE_RUNTIME_ACTIVATION_PRE_ACTIVATION_BOUNDARY_REVIEW',
            'c143_go_decision_finalization_review_carried_forward' => true,
            'c144_production_live_runtime_activation_pre_activation_boundary_review_executed' => true,
            'c144_pre_activation_boundary_cleared' => $pass,
            'c144_ready_for_activation_authorization_review' => $pass,
            'activation_authorized' => false,
    ...
    {
        return [
            'planned_next_review' => $pass ? self::C145_RECOMMENDATION : 'C144_TARGETED_C143_GO_DECISION_FINALIZATION_REPAIR',
            'planned_next_scope' => $pass ? 'production/live runtime activation authorization review only; not official weekly swing output publication or PLAN/CONFIRM mutation in C144' : 'targeted repair before production/live activation pre-activation boundary can be cleared',
            'planned_next_required_inputs' => $pass ? [
                'locked C144 artifact hash',
                'locked C144 file SHA1',
    ...
    private function documentationHygieneGuardSummary(array $load): array
    {
        return [
            ...
            'c143_convert_from_json_pass' => $load['convert_from_json_pass'],
            'top_level_case_insensitive_duplicate_keys' => $load['case_insensitive_duplicate_keys'],
            'c143_artifact_not_modified' => true,
            'c60_c143_artifacts_not_modified' => true,
            'c144_is_pre_activation_boundary_review_not_activation_authorization' => true,
            'phase_label' => self::PHASE_LABEL,
        ];
    }
    ...
    {
        return [
            'C144 validates C143 artifact_hash and file SHA1 locks before production/live runtime activation pre-activation boundary review is recorded.',
            'C144 validates C143 finalized activation GO and next recommendation to C144.',
            'C144 requires --operator-approved, a non-empty --approval-reference, and explicit pre-activation boundary confirmation.',
            'C144 keeps runtime feature flags default-off and checks the kill-switch surface.',
            'C144 keeps E02 primary, B01 backup, and A01 comparator-only.',
            'C144 records artifact-only pre-activation boundary clearance and moves to activation authorization review.',
            'C144 does not authorize activation, activate runtime bridge, execute production runtime wiring, generate official weekly swing output, publish recommendations, or mutate PLAN/CONFIRM.',
            'C144 may only recommend C145 production/live runtime activation authorization review as the next controlled step.',
        ];
    }

    private function c143GoDecisionFinalizationValid(array $c143): bool
    {
        foreach (self::REQUIRED_C143_TRUE_FIELDS as $field) {
            if (($c143[$field] ?? null) !== true) {
                return false;
            }
        }
        foreach (self::REQUIRED_C143_FALSE_FIELDS as $field) {
            if (($c143[$field] ?? null) !== false) {
                return false;
            }
        }
        if (($c143['operator_go_decision'] ?? null) !== 'GO') {
            return false;
        }

        foreach ([
            [['c143_go_decision_finalization_decision', 'review_pass'], true],
            [['c143_go_decision_finalization_decision', 'next_recommendation'], self::EXPECTED_C143_NEXT_RECOMMENDATION],
            [['next_pre_activation_boundary_decision', 'review_pass'], true],
            [['next_pre_activation_boundary_decision', 'next_recommendation'], self::EXPECTED_C143_NEXT_RECOMMENDATION],
            ...
            if ($this->valueAt($c143, $path) !== $expected) {
                return false;
            }
        }
    ...
    private function c143NextRecommendationMatches(array $c143): bool
    {
        foreach ([
            $c143['next_step_recommendation'] ?? null,
            $c143['next_pre_activation_boundary_decision']['next_recommendation'] ?? null,
            $c143['planned_next_summary']['planned_next_review'] ?? null,
        ] as $value) {
            if ($value !== null && $value !== self::EXPECTED_C143_NEXT_RECOMMENDATION) {
                return false;
            }
        }

        return ($c143['next_step_recommendation'] ?? null) === self::EXPECTED_C143_NEXT_RECOMMENDATION;
    }
    ...
    {
        foreach (array_values(array_unique(array_merge(self::REQUIRED_C143_FALSE_FIELDS, self::REQUIRED_FALSE_SAFETY_FLAGS))) as $field) {
    ...
    {
        return [
            'expected_c143_hash' => $load['expected_hash'],
            'actual_c143_hash' => $load['actual_hash'],
            'c143_hash_match' => $load['hash_match'],
            'expected_c143_file_sha1' => $load['expected_file_sha1'],
            'actual_c143_file_sha1' => $load['actual_file_sha1'],
            'c143_file_sha1_match' => $load['file_sha1_match'],
            'c143_convert_from_json_pass' => $load['convert_from_json_pass'],
        ];
    }
