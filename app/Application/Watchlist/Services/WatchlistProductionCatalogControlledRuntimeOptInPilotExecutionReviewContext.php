...
/**
 * Explicit-only C77 pilot execution review context.
 * Not persisted to config, DB, or live runtime; artifact-only proof.
 */
class WatchlistProductionCatalogControlledRuntimeOptInPilotExecutionReviewContext
{
    public const CONTEXT_CODE = 'C77_CONTROLLED_RUNTIME_OPT_IN_PILOT_EXECUTION_REVIEW_CONTEXT';
