    ...
    public function getBenchmarkContext(string $benchmarkCode, string $tradeDate): ?array
    {
        ...
        $row = DB::table('market_benchmarks as bench')
            ...
            ->select(
                ...
                'ind.ma50',
                'ind.ma20_slope_pct',
                'ind.close_to_ma20_pct',
                'ind.close_to_ma50_pct',
        ...
        return [
            ...
            'ma20_slope_pct' => $row->ma20_slope_pct !== null ? (float) $row->ma20_slope_pct : null,
            'close_to_ma20_pct' => $row->close_to_ma20_pct !== null ? (float) $row->close_to_ma20_pct : null,
            'close_to_ma50_pct' => $row->close_to_ma50_pct !== null ? (float) $row->close_to_ma50_pct : null,
